...
-  1x SD card (at least 16GB); follow `this guide <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_ to set up the card
...
.. image:: images/ad4858_fmcz_block_diagram.svg
   :align: center
...
The `AXI_AD4858 <https://wiki.analog.com/resources/fpga/docs/axi_ad4858>`_ IP core contains 2 configuration modes, these being :git-hdl:`CMOS <library/axi_ad485x/axi_ad485x_cmos.v>` and :git-hdl:`LVDS <library/axi_ad485x/axi_ad485x_lvds.v>`. Depending on which of them you want to use, different files are being used (see :git-hdl:`here <projects/ad485x_fmcz/zed/system_project.tcl#L18-L22>`).
...
Check `this guide <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_ on how to prepare your SD card with the proper boot files. A more comprehensive build guide can be found in the `HDL User Guide <https://wiki.analog.com/resources/fpga/docs/hdl>`_.

System setup
------------

.. image:: images/ad4858_fmcz_zed_setup.jpg
   :align: center

As for the signal generator, you can use whichever Signal Generator you want.

In this setup, we chose to use :adi:`M2K <en/ADALM2000.html>` (with a `BNC adapter board <https://wiki.analog.com/university/tools/m2k/accessories/bnc>`_) as signal generator for channel 0, while testing the system in LVDS mode. Using `Scopy <https://wiki.analog.com/university/tools/m2k/scopy>`_, we set the amplitude, frequency, offset and phase of the generated signals.

A more comprehensive guide on how to use :adi:`M2K <en/ADALM2000.html>` and Scopy can be found `here <https://wiki.analog.com/university/tools/m2k/users>`_ and `here <https://wiki.analog.com/university/tools/m2k/scopy>`_.

Resources
~~~~~~~~~

-  :adi:`ADALM2000 (M2K) <en/ADALM2000.html>`
-  `M2K BNC adapter board <https://wiki.analog.com/university/tools/m2k/accessories/bnc>`_
...
-  `AXI_AD4858 IP <https://wiki.analog.com/resources/fpga/docs/axi_ad4858>`_ wiki documentation
-  `AXI_PWM_GEN <https://wiki.analog.com/resources/fpga/docs/axi_pwm_gen>`_ wiki documentation
-  `AXI_CLKGEN <https://wiki.analog.com/resources/fpga/docs/axi_clkgen>`_ wiki documentation
-  `High-Speed DMA Controller Peripheral <https://wiki.analog.com/resources/fpga/docs/axi_dmac>`_ wiki documentation
-  `UTIL_CPACK2 <https://wiki.analog.com/resources/fpga/docs/util_cpack2>`_ wiki documentation
-  `How to prepare an SD card <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_ with boot files
-  `ADI reference designs HDL user guide <https://wiki.analog.com/resources/fpga/docs/hdl>`_
-  `ADI HDL architecture <https://wiki.analog.com/resources/fpga/docs/arch>`_ wiki page
-  `How to build an ADI HDL project <https://wiki.analog.com/resources/fpga/docs/build>`_
...
.. |image1| image:: images/ad4858_fmcz_clock_path.jpg
