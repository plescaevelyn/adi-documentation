...
ADI IIO oscilloscope is used for monitoring and controlling the AD-FMCMOTCON2-EBZ board, when using the Linux operating system. A complete user guide for the IIO oscilloscope can be found `here <https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope>`_.
...
.. image:: ../images/mc_iio_signals.png
