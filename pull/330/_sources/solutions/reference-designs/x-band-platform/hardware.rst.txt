...
-  1x `ADAR1000EVAL1Z (Stingray) <https://wiki.analog.com/resources/eval/user-guides/stingray>`_

   -  Heatsink and H-Frame Mechanical Hardware `Assembly Instructions <resources/stingray_assembly_v2.pdf>`_
...
-  `Interposer Board (connect FPGA control lines to XUD1A) <https://wiki.analog.com/resources/eval/user-guides/xud1a/user-guide>`_
...
.. image:: images/xbdp-wiki-system-block-diagram.png
   :align: center
...
For more details, review the ADAR1000EVAL1Z `Primary Side <images/adar1000eval1z_top-web.gif>`_ and `Secondary Side <images/adar1000eval1z_bottom-web.gif>`_ board images, the `ADXUD1AEBZ Primary Side <images/eval-adxud1aebz_top-web.gif>`_ board image, and the :adi:`AD9081-EVAL <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/EVAL-AD9081.html#eb-overview>` images.
...
The default LO configuration for the XUD1A is for an external LO via SMA-F connector. The LO is common across all 4 up/down converter channels via splitter network. Refer to the `XUD1A Block Diagram <https://wiki.analog.com/resources/eval/user-guides/xud1a/user-guide>`_ for more details.
...
.. |image1| image:: images/platformblockdiagram.jpg
   :width: 1000
.. |image2| image:: images/xud1a_fmc_v2.png
   :width: 600
.. |MxFE Connection| image:: images/mxfe_connection.jpg
   :width: 1000
.. |image3| image:: images/xbdp_hardwareconnectiondiagram.png
.. |image4| image:: images/ad9081-xud1a-connect.png
   :width: 600
.. |image5| image:: images/ad9081_default_clk.png
.. |image6| image:: images/ad9081_direct_clk.png
.. |image7| image:: images/xud1a_lo_pll.png
.. |image8| image:: images/xud1a_rework_onboard_pll.png
   :width: 600
.. |SW6 Configuration for SD Card Boot| image:: images/zcu102_sw6_sdcard.jpg
.. |image9| image:: images/adar1000eval1z_tr_probe.png
   :width: 400
.. |image10| image:: images/ad9081_ltm4616_en_resistor_r1m.png
   :width: 600
