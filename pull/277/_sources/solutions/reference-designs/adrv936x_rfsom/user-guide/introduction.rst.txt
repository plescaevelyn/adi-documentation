...
-  **Small form factor:** 100mm x 62mm footprint, compliant with `DP10062 “Sick of Beige v1.0 <http://dangerousprototypes.com/docs/Sick_of_Beige_standard_PCB_sizes_v1.0>`_ DP10062 “Sick of Beige v1.0” enclosures from `dangerousprototypes.com <http://dangerousprototypes.com/docs/Sick_of_Beige_standard_PCB_sizes_v1.0>`_.
...
-  **Open-source code:** Analog Devices provides precompiled reference designs on the :doc:`ADRV9361 Wiki Page </solutions/reference-designs/adrv936x_rfsom/adrv936x_rfsom>` and a source code support package hosted on Github, including the HDL and software code.
...
.. image:: ../images/simplified_system_diagram.png
...
.. |ADRV9361-Z7035 SOM Device Callout| image:: ../images/adrv9361-z7035_device_callout.png
   :width: 800
