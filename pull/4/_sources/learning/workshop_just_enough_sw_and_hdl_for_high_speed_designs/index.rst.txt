...
The USB bootable image for the hands-on exercises is provided here:

.. admonition:: Download

   `SDR Lab Image <https://swdownloads.analog.com/cse/kuiper/FTC2023_SDR.zip>`_
...
* :adi:`AD-JUPITER-EBZ <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/ad-jupiter-ebz.html>`
* :adi:`ADRV9009-ZU11EG RF-SOM (Talise) <https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/adrv9009-zu11eg.html>`
* USB cable
* SMA cables for loopback connections
* Two antennas for wireless experiments
* PC with USB boot capability
* USB drive (minimum 16GB) with the provided SDR Lab Image (see Downloads section above) or an image that you set up yourself with the required software
* Monitor, keyboard, and mouse

**Software Requirements**:

The provided USB bootable image contains all necessary software pre-installed. If setting up your own environment, you will need:

* `Python <https://www.python.org/>`_ 3.7 or newer
* `PyADI-IIO <https://github.com/analogdevicesinc/pyadi-iio>`_ library
* `GNU Radio <https://www.gnuradio.org/>`_ 3.8 or newer with `gr-iio <https://github.com/analogdevicesinc/gr-iio>`_ blocks
* `Scopy <https://analogdevicesinc.github.io/scopy/>`_ or `IIO Oscilloscope <https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope>`_
* `libiio <https://github.com/analogdevicesinc/libiio/>`_ library
...
#. ACE (Analysis, Control, and Evaluation) Software
#. IIO Oscilloscope
#. Scopy
#. qIQ Receiver
#. Matlab and Simulink
...
* Start with `ADALM-PLUTO <https://www.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/adalm-pluto.html>`_:
...
.. note::
   ...
   The following exercises should be run on a PC booted from the provided USB bootable image (available in the Downloads section above).
...
#. `ADALM-PLUTO <https://www.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/adalm-pluto.html>`_

#. `Jupiter SDR Hardware Overview <https://wiki.analog.com/resources/eval/user-guides/jupiter-sdr/hardware-overview>`_

#. `ADRV9009-ZU11EG SOM <https://www.analog.com/en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/adrv9009-zu11eg.html>`_

#. T. F. Collins, R. Getz, Di Pu, A. M. Wyglinski, "Software-Defined Radio for Engineers," 2018, ISBN-13: 978-1-63081-457-1

#. `GNU Radio <https://www.gnuradio.org/>`_

#. M. Lichtman, `PySDR: A Guide to SDR and DSP using Python <https://pysdr.org/>`_

#. T. F. Collins, `ADI Transceivers: A Deep Dive <https://www.gnuradio.org/grcon/grcon18/presentations/ADI_Transceivers_A_Deep_Dive/>`_, GNU Radio Conference 2018

#. J. Gallicchio, `learnSDR <https://github.com/gallicchio/learnSDR>`_

#. `SDRangel <https://www.sdrangel.org/>`_

#. K. Mueller and M. Muller, "Timing recovery in digital synchronous data receivers," IEEE Trans. Commun., vol. C-24, no. 5, pp. 516-531, May 1976

#. J. Costas, "Synchronous Communications," Proceedings of the IEEE, vol. 44, p. 1713-1718, 1956
