...
The following example shows a set of these configuration options. These
variables are fully documented in adxl34x header file
...
To attach devices to drivers, the platform and bus model eliminates the need for
device drivers to contain hard coded physical addresses or bus IDs of the
