ADI VSM Watch Video Series
==========================

On this page, there will be various training videos to help you get your ADI VSM
Watch up and running. These video topics include:

-  How to Connect to ADI's GUI - Applications WaveTool (via BLE or USB cable)
-  How to Upgrade the Firmware
-  Selecting Sensors or Applications
-  Overview of 5 Use Cases: Which One Should I Use?
-  Overview of Use Case 1
-  Overview of Use Case 2
-  Overview of Use Case 3
-  Overview of Use Case 4
-  Overview of Use Case 5
-  How to Retrieve Logged Data
-  How to Clear and Reset the File System
-  How to Use Low Touch Logging

| **See the Videos below:**

| **How to Connect to ADI's GUI - Applications WaveTool (via BLE or USB cable)** |youtube>JEm5utKxjrY|

| **How to Upgrade the Firmware** |youtube>ojxdQEgQynA|

| **Selecting Sensors or Applications** |youtube>OvM54pmgVuc|

| **Overview of 5 Use Cases: Which One Should I Use?** |youtube>q0hRQZHGqFY|

| **Overview of Use Case 1** |youtube>1KhPx6qonRM|

| **Overview of Use Case 2** |youtube>theDCJN5lMQ|

| **Overview of Use Case 3** |youtube>52upPOkD2g0|

| **Overview of Use Case 4** |youtube>SIQyYwvXgYk|

| **Overview of Use Case 5** |youtube>4oUPaDURzBg|

| **How to Retrieve Logged Data** |youtube>vRrNuFbJFGM|

| **How to Clear and Reset the File System** |youtube>63CXfqUO0m4|
