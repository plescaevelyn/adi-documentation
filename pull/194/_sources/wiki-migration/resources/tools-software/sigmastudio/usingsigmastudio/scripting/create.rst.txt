...
To pause a SigmaStudio Script, in the Script Editor Window, click on main menu Tools > Pause, see Figure 5.
...
To stop a SigmaStudio Script, in the Script Editor Window, click on main menu Tools > Stop, see Figure 7.


|image5|

if the script successfully stops, a dialog detailing the script execution halted is displayed and “Script Aborted” is shown in the status bar.
