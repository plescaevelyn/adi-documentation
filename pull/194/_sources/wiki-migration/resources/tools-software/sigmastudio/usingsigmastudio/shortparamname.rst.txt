...
#define MOD\_<<Heirarchy Board Names separated by \_>>\_<<Module Label>>_ALG<<Algorithm Index>>\_<<AlgorithmInternalName>><AlgorithmInstanceNumber>>\_<<ParameterName>>_ADDR

When the short parameter name is enabled the parameter will be shortened as follows. #define ADDR\_<<Module Label>>\_<<ParameterName>>
