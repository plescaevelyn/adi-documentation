...
quickly mute the particular gain. The current mixer (Mix #) can be changed
during the runtime.
...
If the input/output channels are more than 17, then the mixer window is split
for 17 input/output channels to improve GUI performance.
