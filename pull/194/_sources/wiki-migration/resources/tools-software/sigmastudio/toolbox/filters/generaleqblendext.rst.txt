General EQ With External Blend
==============================

:doc:`Click here to return to the Filters page </wiki-migration/resources/tools-software/sigmastudio/toolbox/filters>`

The 'General EQ with External Blend' block blends the filter coefficients of two
second order filters according to the blend factor specified and performs
...
-  Blend EQ single precision algorithm(ADAU145x): BlendEQExtSPAlg
-  Blend EQ double precision algorithm(ADAU145x): BlendEQExtDPAlg
-  Blend EQ single precision algorithm(ADSPSC5xx): MChBlendExtFiltAlg
