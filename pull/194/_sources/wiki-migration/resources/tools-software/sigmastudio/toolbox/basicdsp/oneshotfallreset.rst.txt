...
reset signal through the OneShotFallReset block. In the graphs the input signal
is only toggling between "1" and "0" however this algorithm will respond to any
changes in level of the input signal, thus the first falling edge of the input
