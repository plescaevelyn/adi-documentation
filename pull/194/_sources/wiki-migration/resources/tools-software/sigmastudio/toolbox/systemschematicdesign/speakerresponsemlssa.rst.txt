...
The Speaker Response algorithm uses the MLSSA (maximum-length-sequence system
analyzer, an industry standard) loudspeaker measurement system (www.mlssa.com).
To employ this block:
...
This speaker response cell serves as an informational tool only. It does not
have any intelligence that attempts to correct for the frequency response of the
speaker. It is up to the user to tune the frequency response as needed.
...
Example MLSSA files can be found in the SigmaStudio install directory's Speaker
