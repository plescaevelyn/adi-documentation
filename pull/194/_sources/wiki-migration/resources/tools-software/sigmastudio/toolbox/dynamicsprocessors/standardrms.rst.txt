...
The Standard RMS Compressor is meant to function like most other SigmaStudio
compressors. The performance and main algorithm driving the Standard RMS is the
same as the other compressors in the same library folder (RMS - Standard
...
Standard Independent RMS compressor should be used. This allows different
