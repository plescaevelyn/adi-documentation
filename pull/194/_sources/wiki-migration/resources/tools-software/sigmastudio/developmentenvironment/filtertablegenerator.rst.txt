...
The Filter Table Generator dialog is used to calculate filter coefficients and
coefficient tables. Go to Tools - Fixed-Point Filter Table Generator... in the
main application menu to access this dialog.
...
This tool is most useful for designing a set of filter coefficients with stepped
gain response (as in the above image) for such applications as an graphic
equalizer.
