...
-  :doc:`Main Board </wiki-migration/resources/tools-software/sharc-audio-module/hardware/main-board>` - Hardware reference guide for the SHARC Audio Module main board.
-  :doc:`Audio Project Fin </wiki-migration/resources/tools-software/sharc-audio-module/hardware/audioproj-fin>` - Hardware reference guide for the Audio Project Fin that connects to the SHARC Audio Module main board using the expansion interface.
