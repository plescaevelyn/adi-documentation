...
The purpose of this article is to give a brief overview of how to export XML files from SigmaStudio which can then be used to discover an A2B Network in the Audio Starter projects. :doc:`See our A2B Audio example usage here! </wiki-migration/resources/tools-software/sharc-audio-module/advanced-audio-projects/examples-a2b-audio>`

Details
-------

*Follow the steps below to export an A2B XML file from SigmaStudio.*
