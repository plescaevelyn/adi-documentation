...
The video below provides a walk-through of getting CCES configured to begin
developing code and debugging this code in CCES and on the SHARC Audio Module.
The steps covered in this video are also briefly outlined below and are provided
to help with a better debug experience.
...
-  Once the files have been downloaded and the debugger is halted at the start
   of main(), go to Target->Settings->Target Options... Check the "Mask
   interrupts during step" checkbox.
