...
| Source                                                                                                                              | Mainlined? |
+=====================================================================================================================================+============+
| `drivers/dma/dma-axi-dmac.c <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/dma/dma-axi-dmac.c>`_  | Yes        |
+-------------------------------------------------------------------------------------------------------------------------------------+------------+
...
| Function      | File                                                                                                                                                                      |
+===============+===========================================================================================================================================================================+
| driver        | :git-linux:`drivers/dma/dma-axi-dmac.c`                                                                                                                                   |
+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| include       | :git-linux:`include/dt-bindings/dma/axi-dmac.h`                                                                                                                           |
+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Documentation | :git-linux:`Documentation/devicetree/bindings/dma/adi,axi-dmac.txt`                                                                                                       |
+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  `Linux DMAEngine documentation <https://www.kernel.org/doc/html/latest/driver-api/dmaengine/index.html>`_
