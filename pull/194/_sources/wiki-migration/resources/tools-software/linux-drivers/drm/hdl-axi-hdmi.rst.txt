...
The AXI HDMI HDL driver is the driver for the HDL graphics core which is used on various FPGA designs interfacing to the `adv7511 <https://wiki.analog.com/adv7511>`_. The driver is implemented as a DRM KMS driver.
...
| Source                                                                                                                                          | Mainlined?                                                                                                           |
+=================================================================================================================================================+======================================================================================================================+
| :git-linux:`drivers/gpu/drm/analog/analog_drm_drv.c <drivers/gpu/drm/adi_axi_hdmi/axi_hdmi_drv.c>`                                              | `WIP <https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/gpu/drm/adi/axi_hdmi_drv.c>`_  |
+-------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
...
| Function | File                                                                                                                                               |
+==========+====================================================================================================================================================+
| driver   | :git-linux:`drivers/gpu/drm/adi/axi_hdmi_drv.c <drivers/gpu/drm/adi_axi_hdmi/axi_hdmi_drv.c>`                                                      |
+----------+----------------------------------------------------------------------------------------------------------------------------------------------------+
| driver   | :git-linux:`drivers/gpu/drm/adi/axi_hdmi_drv.h <drivers/gpu/drm/adi_axi_hdmi/axi_hdmi_drv.h>`                                                      |
+----------+----------------------------------------------------------------------------------------------------------------------------------------------------+
| driver   | :git-linux:`drivers/gpu/drm/adi/axi_hdmi_crtc.c <drivers/gpu/drm/adi_axi_hdmi/axi_hdmi_crtc.c>`                                                    |
+----------+----------------------------------------------------------------------------------------------------------------------------------------------------+
| driver   | :git-linux:`drivers/gpu/drm/adi/axi_hdmi_encoder.c <drivers/gpu/drm/adi_axi_hdmi/axi_hdmi_encoder.c>`                                              |
+----------+----------------------------------------------------------------------------------------------------------------------------------------------------+
...
-  reg: Base address and register area size. This parameter expects two register ranges. The first for the axi-hdmi core's registers and the second for the axi-clockgen core's registers.
...
The driver can be tested using the `Linux framebuffer console <http://www.mjmwired.net/kernel/Documentation/fb/fbcon.txt>`_.
...
The Xorg graphical environment can be used with driver either using `xf86-video-fbdev <http://cgit.freedesktop.org/xorg/driver/xf86-video-fbdev/>`_ or the `xf86-video-modesetting <http://cgit.freedesktop.org/xorg/driver/xf86-video-modesetting/>`_ Xorg module.
...
Since the driver registers a `Linux framebuffer device <https://en.wikipedia.org/wiki/Linux_framebuffer>`_ it is possible to use any application or toolkit which has support for it to display graphics on the HDMI output. This for example includes `DirectFB <http://directfb.org/>`_, `mplayer <http://www.mplayerhq.hu/>`_ and `SDL <http://www.libsdl.org/>`_.
