...
The ADI Linux kernel can also be compiled using Petalinux to be used on Xilinx SoC FPGA based platforms (using :git-meta-adi>`__). The following table specifies the supported Petalinux versions (plus documentation):

+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| Petalinux version | Meta-adi branch                                                                              | Documentation                                                              |
+===================+==============================================================================================+============================================================================+
| 2018.2            | `2018_R2 <https::`ADI Yocto repository </github.com/analogdevicesinc/meta-adi/tree/2018_R2>` | `README <https://github.com/meta-adi?2018_R2/meta-adi-xilinx/README.md>`_  |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2018.3            | :git-meta-adi:`tree/2019_R1`                                                                 | `README <https://github.com/meta-adi?2019_R1/meta-adi-xilinx/README.md>`_  |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2019.1            | :git-meta-adi:`tree/2019_R2`                                                                 | `README <https://github.com/meta-adi?2019_R2/meta-adi-xilinx/README.md>`_  |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2021.1            | :git-meta-adi:`tree/2021_R1`                                                                 | `README <https://github.com/meta-adi?2021_R1/meta-adi-xilinx/README.md>`_  |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| 2021.2            | :git-meta-adi:`tree/master`                                                                  | `README <https://github.com/meta-adi?master/meta-adi-xilinx/README.md>`_   |
+-------------------+----------------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
...
You should see the board start-up messages as follows:
