...
This section provides a detailed description of the SigmaStudio+ for SHARC
(ADSP-SC5xx/ADSP-215xx) Target Library API structures and functions. The
sections describing the SigmaStudio+ target library is organized as follows:
