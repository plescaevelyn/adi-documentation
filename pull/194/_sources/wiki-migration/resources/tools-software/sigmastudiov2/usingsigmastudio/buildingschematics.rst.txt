...
Double click on the processor block of the platform to go to schematic design window.
...
-  Review the SPORT settings for the target application based on your platform design

.. image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/usingsigmastudio/sport_settings.png
   :width: 720px

-  Select corresponding application executables (DXE's) for each of the cores in SHARC Core settings window
