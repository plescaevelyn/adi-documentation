...
This action allows the user to migrate the target of a specified module in the
canvas. The function call requires 3 arguments to be passed. This API returns
the SSPResult type
...
-  copyPlatformSpecificProperties - used to determine whether to copy
