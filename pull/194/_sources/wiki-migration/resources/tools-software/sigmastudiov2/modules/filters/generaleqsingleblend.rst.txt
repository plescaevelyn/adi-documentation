...
|singleblend.png| |singleextblend.png|

.. image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/modules/filters/singleeqblendfiltsettings.png
   :alt: singleeqblendfiltsettings.png
...
modifications are common for all the stages.
...
+=========================+============+==================+===============+==================+
| GeneralEqSingleBlend    | B/S        | B/S              | S             | B                |
+-------------------------+------------+------------------+---------------+------------------+
| GeneralEqSingleBlendExt | B/S        | B/S              | S             | B                |
+-------------------------+------------+------------------+---------------+------------------+
...
.. |singleblend.png| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/modules/filters/singleblend.png
.. |singleextblend.png| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/modules/filters/singleextblend.png
