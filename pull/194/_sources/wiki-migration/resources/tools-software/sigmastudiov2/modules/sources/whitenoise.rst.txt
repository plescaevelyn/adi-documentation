...
The White Noise block generates a signal that contains equal energy per
frequency domain(hertz or similar increament).This random time-varying signal
can be useful for testing equipment, although for audio situations white noise
is commonly run through a pinking filter, to better simulate the behavior and
