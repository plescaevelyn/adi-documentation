...
.. note::
   ...
   The ADSP-SC589 Mini board version 2.1 is supported from SigmaStudio+ version
   2.3.0 by default. To use the older version of ADSP-SC589 Mini boards, the “\
   ADSPSC589_SAM_BOARD_2_1\ ” macro in the ADSP-SC589-SAM demo application can
   be disabled using CCES project compiler properties.
...
.. |image1| image:: https://wiki.analog.com/_media/resources/tools-software/sigmastudiov2/supportedplatforms/adzs-sc589-mini.png
   :width: 600
