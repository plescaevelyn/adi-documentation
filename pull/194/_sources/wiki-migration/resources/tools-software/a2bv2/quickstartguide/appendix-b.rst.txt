...
SS+ provides options for configuring A2B streams in the network, allows export
of bus config and Commandlist files.
...
.. note::
   ...
   The exported files can be used with the stack and target examples in the
   19.10.0 version of the software. The target demo examples can be found at
   <<A2B software 19.10.0 installation path>>\\Target\\examples\\demo.
...
-  Define path for the binary file - A2B_CONF_BINARY_BCF_FILE_URL in
   a2bapp_defs.h

   -  (<<A2B software 19.10.0 installation
      path>>\\Target\\examples\\demo\\a2b-xx\\app\\a2bapp_defs.h)
...
list into a single command list to support branching.
