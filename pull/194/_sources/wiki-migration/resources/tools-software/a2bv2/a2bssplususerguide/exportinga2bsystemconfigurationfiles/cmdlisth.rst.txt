...
Details of A2B Stack and SigmaStudio version used during export is available in
the Command list header file under copyright section.
...
.. tip::
   ...
   .. container:: left round
      ...
      \* @date: Thursday, 27 June 2024-17:20:07 \* I2C/SPI Command File Version
      - 1.0.0 \* A2B SDK DLL- 1.3.1.0 \* A2B Stack DLL version- 19.10.9.0 \*
