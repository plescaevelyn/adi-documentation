...
processors. With SigmaStudio+, the A2B Master node and Subnode can be
configured, as illustrated in the attached image.
...
figure illustrates the stream configuration for the 243x Transceiver.
...
required, which can be generated as shown below. This .bcf file is necessary for
building the A2B Stack application for the Raspberry Pi board.
...
.. note::
   ...
   The same .dts file can be used for both 242x and 243x transceivers without
   any issues.
