...
`ADALM-PLUTO Radio Support from Communications Toolbox <https://www.mathworks.com/hardware-support/adalm-pluto-radio.html>`_ enables you to prototype and test software-defined radio (SDR) systems using Analog Devices ADALM-PLUTO with MATLAB and Simulink.

ADALM1000
---------

`Analog Devices ADALM1000 Support from Data Acquisition Toolbox <https://www.mathworks.com/hardware-support/analog-devices-adalm1000.html>`_ enables you to acquire data from Analog Devices ADALM1000 using MATLAB.

AD9361 / AD9364
---------------

In the poorly named `Zynq SDR Support from Communications Toolbox <https://www.mathworks.com/hardware-support/zynq-sdr.html>`_, MathWorks supports many AD9361 and AD9364 based platforms, including:

-  :adi:`ADRV9361-Z7035` RF SOM
-  :adi:`AD-FMCOMMS2-EBZ`, :adi:`AD-FMCOMMS3-EBZ`, and the :adi:`AD-FMCOMMS4-EBZ` on the Xilinx `ZCU102 <https://www.xilinx.com/ZCU102>`_, `ZC706 <https://www.xilinx.com/ZC706>`_ or ZedBoard
-  :adi:`AD-FMCOMMS5-EBZ` on the Xilinx `ZC706 <https://www.xilinx.com/ZC706>`_
