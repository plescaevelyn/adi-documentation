AD5592R/AD5593R Console Application
===================================

Introduction
------------

The :adi:`AD5592R <en/products/ad5592r.html>`/:adi:`AD5593R <en/products/ad5593r.html>` offer 8-Channel, 12-Bit, configurable ADC/DAC with on-chip reference and either SPI (AD5592R) or I2C interfaces (AD5593R). This page gives an overview of using the AD5592R/AD5593R firmware example with :adi:`SDP-K1 <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/sdp-k1.html>` EVAL board. The firmware example comprises 3 layers of software (from top to bottom): Console Application Layer, Device No-OS Layer and Platform Drivers (Mbed-OS) layer.
...
-  :adi:`AD5592R Evaluation Board <EVAL-AD5592R>`
-  :adi:`AD5593R Evaluation Board <EVAL-AD5593R>`
