...
will cease. All future maintenance for the ADSP-SC594 will then be incorporated
...
This is the first release of the Yocto Linux for ADSP-SC594 Processor. This is
an intermediate release and it does not support any other processors. For
existing supported processors please continue to use the 1.0 Release. The
following changes have been applied since the 1.0 release of Yocto Linux for
