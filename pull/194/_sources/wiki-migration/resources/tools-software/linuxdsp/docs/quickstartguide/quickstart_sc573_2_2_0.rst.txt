Yocto Linux 2.2.0 Quickstart Guide for ADSP-SC573
=================================================
...
.. important::
   ...
   The following instructions are for the ADSP-SC573-EZKIT development board. For instructions for other processors and development boards please refer to :doc:`Linux for ADSP-SC5xx Processors 2.2.0 (develop) </wiki-migration/resources/tools-software/linuxdsp/releaselandingpages/2.2.0>`\
...
::
   ...
   $ cp tmp/deploy/images/adsp-sc573-ezkit/u-boot-sc573-ezkit /tftpboot/
...
In a third console window launch GDB and type ``target extended-remote :3333``. This will make GDB to connect to the gdbserver on the local host using port 3333. Then, load the init file into RAM by typing ``load init-sc573-ezkit.elf`` and run it by typing ``c``. Hit Ctrl+C to interrupt thereafter.
...
::
   ...
   Filename 'u-boot-sc573-ezkit.ldr'.
   Load address: 0x82000000
   Loading: ############################
            2.7 MiB/s
   done
   Bytes transferred = 399416 (61838 hex)
   SF: Detected w25q128 with page size 256 Bytes, erase size 4 KiB, total 16 MiB
   SF: 524288 bytes @ 0x0 Erased: OK
   device 0 offset 0x0, size 0x61838
...
In order to boot Linux, the TFTP server should be setup as :doc:`above </wiki-migration/resources/tools-software/linuxdsp/docs/quickstartguide/quickstart_sc573>` and (for both NFS and RAM boot) a copy of the kernel image should be copied into the **/tftpboot** directory.
...
::
   ...
   $ cp tmp/deploy/images/adsp-sc573-ezkit/adsp-sc5xx-ramdisk-adsp-sc573-ezkit.cpio.xz.u-boot /tftpboot/ramdisk.cpio.xz.u-boot
