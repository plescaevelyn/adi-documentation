...
This page provides how to use the USB Gadget mass storage on ADSP-SC5xx board,
and it will include the below test:
...
Gadget only mode, and enable the USB Gadget Mass Storage relevant options.
