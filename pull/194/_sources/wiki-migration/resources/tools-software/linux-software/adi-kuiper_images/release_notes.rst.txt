...
.. container:: lo round box
   ...
   **Release Image**
   ...
   -  `Github Release Notes for Kuiper 2023_r2 Patch1 <https://github.com/analogdevicesinc/adi-kuiper-gen/releases/tag/2023_r2_p1>`_
   ...
   .. admonition:: Download
      :class: download
         ...
         -  `Kuiper Imager tool <https://github.com/analogdevicesinc/adi-kuiper-imager/releases/tag/v1.0.0-rc3>`_ can be also used for etching the image on SD card, configure the image for a specific hardware setup and update the boot files to latest.
...
.. container:: lo round box
   ...
   **Known issues**
   ...
   1. Writing SD cards with Balena Etcher(Windows) or Disk Image Writer(Ubuntu)
      may give an error at the end
   
   Even so, SD cards should be written properly, so you can ignore it. As
   alternatives you can use Win32 Disk Imager (version 1.0) from Windows or 'dd'
   command from linux systems.
   ...
   The issue is reproducible only when sampling frequency is set from a lower to
   a higher value.
   ...
   **Sources**
   ...
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Scopy                           | `scopy.git <https://github.com/analogdevicesinc/scopy>`_                                          |             | **v2.0.0-beta-rc2** |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libm2k                          | `libm2k.git <https://github.com/analogdevicesinc/libm2k>`_                                        |             | **v0.9.0**          |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Pyadi-iio                       | `pyadi-iio.git <https://github.com/analogdevicesinc/pyadi-iio>`_                                  |             | **v0.0.19**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Kuiper                          | `adi-kuiper-gen.git <https://github.com/analogdevicesinc/adi-kuiper-gen>`_                        | 2023_R2     | **3126a32**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | HDL                             | `hdl.git <https://github.com/analogdevicesinc/hdl>`_                                              | hdl_2023_r2 | **d146370**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux                           | `linux.git <https://github.com/analogdevicesinc/linux>`_                                          | 2023_R2     | **2e89089**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux_RPI                       | `linux.git <https://github.com/analogdevicesinc/linux>`_                                          | rpi-6.1.y   | **a349cf5**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux_image_ADI-scripts         | `linux_image_ADI-scripts.git <https://github.com/analogdevicesinc/linux_image_ADI-scripts>`_      | main        | **c643dd0**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libiio                          | `libiio.git <https://github.com/analogdevicesinc/libiio>`_                                        | 2023_R2     | **5e1e9cb**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | IIO-Osc                         | `iio-oscilloscope.git <https://github.com/analogdevicesinc/iio-oscilloscope>`_                    | 2023_R2     | **89b3848**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libad9361-iio                   | `libad9361-iio.git <https://github.com/analogdevicesinc/libad9361-iio>`_                          | 2023_R2     | **d692a52**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libad9166-iio                   | `libad9166-iio.git <https://github.com/analogdevicesinc/libad9166-iio>`_                          | 2023_R2     | **2916da3**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Fru_tools                       | `fru_tools.git <https://github.com/analogdevicesinc/fru_tools>`_                                  | 2023_R2     | **4a18979**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | IIO-fm-radio                    | `iio-fm-radio.git <https://github.com/analogdevicesinc/iio-fm-radio>`_                            | main        | **e67be7e**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Wiki-scripts                    | `wiki-scripts.git <https://github.com/analogdevicesinc/wiki-scripts>`_                            | main        | **ded20fd**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Jesd-eye-scan-gtk               | `jesd-eye-scan-gtk.git <https://github.com/analogdevicesinc/jesd-eye-scan-gtk>`_                  | 2023_R2     | **f3babfb**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Diagnostic_report               | `diagnostic_report.git <https://github.com/analogdevicesinc/diagnostic_report>`_                  | main        | **fc0ba06**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Colorimeter                     | `colorimeter.git <https://github.com/analogdevicesinc/colorimeter>`_                              | 2023_R2     | **db018d4**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
...
.. collapsible:: **2023_r2** Kuiper Linux Releases (Click to expand)

   \* `Github Release Notes for Kuiper 2023_r2 <https://github.com/analogdevicesinc/adi-kuiper-gen/releases/tag/2023_r2>`_
   ...
   .. container:: lo round box
      ...
      **Known issues**
      ...
      1. Writing SD cards with Balena Etcher(Windows) or Disk Image
         Writer(Ubuntu) may give an error at the end

      Even so, SD cards should be written properly, so you can ignore it. As
      alternatives you can use Win32 Disk Imager (version 1.0) from Windows or
      'dd' command from linux systems.
      ...
      The issue is reproducible only when sampling frequency is set from a lower
      to a higher value.
      ...
      Evaluation Board AD9081 vcxo122p88 on ZCU102 doesn't boot due to a SPI
      issue.

      Please use a previous Kuiper Linux release until we will publish a fix.

      7. "Segmentation Fault" issue on all evaluation boards that use ad7768
         device
      ...
      **Sources**
      ...
      | Kernel version          |                                                                                                   |             | **6.1**             |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Scopy                   | `scopy.git <https://github.com/analogdevicesinc/scopy>`_                                          |             | **v1.4.1**          |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libm2k                  | `libm2k.git <https://github.com/analogdevicesinc/libm2k>`_                                        |             | **v0.8.0**          |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Pyadi-iio               | `pyadi-iio.git <https://github.com/analogdevicesinc/pyadi-iio>`_                                  |             | **v0.0.18**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Kuiper                  | `adi-kuiper-gen.git <https://github.com/analogdevicesinc/adi-kuiper-gen>`_                        | 2023_R2     | **a10c8bc**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | HDL                     | `hdl.git <https://github.com/analogdevicesinc/hdl>`_                                              | hdl_2023_r2 | **2156ac7**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux                   | `linux.git <https://github.com/analogdevicesinc/linux>`_                                          | 2023_R2     | **54eb23f**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux_RPI               | `linux.git <https://github.com/analogdevicesinc/linux>`_                                          | rpi-6.1.y   | **de2e45c**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux_image_ADI-scripts | `linux_image_ADI-scripts.git <https://github.com/analogdevicesinc/linux_image_ADI-scripts>`_      | main        | **2b8b630**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libiio                  | `libiio.git <https://github.com/analogdevicesinc/libiio>`_                                        | 2023_R2     | **bdd5c00**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | IIO-Osc                 | `iio-oscilloscope.git <https://github.com/analogdevicesinc/iio-oscilloscope>`_                    | 2023_R2     | **fbd5aa5**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libad9361-iio           | `libad9361-iio.git <https://github.com/analogdevicesinc/libad9361-iio>`_                          | 2023_R2     | **d692a52**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libad9166-iio           | `libad9166-iio.git <https://github.com/analogdevicesinc/libad9166-iio>`_                          | 2023_R2     | **2916da3**         |
      ...
      | Wiki-scripts            | `wiki-scripts.git <https://github.com/analogdevicesinc/wiki-scripts>`_                            | main        | **ded20fd**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Jesd-eye-scan-gtk       | `jesd-eye-scan-gtk.git <https://github.com/analogdevicesinc/jesd-eye-scan-gtk>`_                  | 2023_R2     | **90cad36**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Diagnostic_report       | `diagnostic_report.git <https://github.com/analogdevicesinc/diagnostic_report>`_                  | main        | **fc0ba06**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Colorimeter             | `colorimeter.git <https://github.com/analogdevicesinc/colorimeter>`_                              | 2023_R2     | **524674a**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+

 

.. collapsible:: Previous Kuiper Linux Releases (Click to expand)
