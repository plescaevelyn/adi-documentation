...
.. container:: lo round box
   ...
   **Sources**
   ...
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Scopy                           | :git-scopy:`scopy`                                                                                |             | **v2.0.0-beta-rc2** |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libm2k                          | :git-libm2k:`libm2k`                                                                              |             | **v0.9.0**          |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Pyadi-iio                       | :git-pyadi-iio:`pyadi-iio`                                                                        |             | **v0.0.19**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Kuiper                          | :git-adi-kuiper-gen:`adi-kuiper-gen`                                                              | 2023_R2     | **3126a32**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | HDL                             | :git-hdl:`hdl`                                                                                    | hdl_2023_r2 | **d146370**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux                           | :git-linux:`linux`                                                                                | 2023_R2     | **2e89089**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux_RPI                       | :git-linux:`linux`                                                                                | rpi-6.1.y   | **a349cf5**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Linux_image_ADI-scripts         | :git-linux_image_ADI-scripts:`linux_image_ADI-scripts`                                            | main        | **c643dd0**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libiio                          | :git-libiio:`libiio`                                                                              | 2023_R2     | **5e1e9cb**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | IIO-Osc                         | :git-iio-oscilloscope:`iio-oscilloscope`                                                          | 2023_R2     | **89b3848**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libad9361-iio                   | :git-libad9361-iio:`libad9361-iio`                                                                | 2023_R2     | **d692a52**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Libad9166-iio                   | :git-libad9166-iio:`libad9166-iio`                                                                | 2023_R2     | **2916da3**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Fru_tools                       | :git-fru_tools:`fru_tools`                                                                        | 2023_R2     | **4a18979**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | IIO-fm-radio                    | :git-iio-fm-radio:`iio-fm-radio`                                                                  | main        | **e67be7e**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Wiki-scripts                    | :git-wiki-scripts:`wiki-scripts`                                                                  | main        | **ded20fd**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Jesd-eye-scan-gtk               | :git-jesd-eye-scan-gtk:`jesd-eye-scan-gtk`                                                        | 2023_R2     | **f3babfb**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Diagnostic_report               | :git-diagnostic_report:`diagnostic_report`                                                        | main        | **fc0ba06**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
   | Colorimeter                     | :git-colorimeter:`colorimeter`                                                                    | 2023_R2     | **db018d4**         |
   +---------------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
...
.. collapsible:: **2023_r2** Kuiper Linux Releases (Click to expand)
   ...
   .. container:: lo round box
      ...
      **Sources**
      ...
      | Kernel version          |                                                                                                   |             | **6.1**             |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Scopy                   | :git-scopy:`scopy`                                                                                |             | **v1.4.1**          |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libm2k                  | :git-libm2k:`libm2k`                                                                              |             | **v0.8.0**          |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Pyadi-iio               | :git-pyadi-iio:`pyadi-iio`                                                                        |             | **v0.0.18**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Kuiper                  | :git-adi-kuiper-gen:`adi-kuiper-gen`                                                              | 2023_R2     | **a10c8bc**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | HDL                     | :git-hdl:`hdl`                                                                                    | hdl_2023_r2 | **2156ac7**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux                   | :git-linux:`linux`                                                                                | 2023_R2     | **54eb23f**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux_RPI               | :git-linux:`linux`                                                                                | rpi-6.1.y   | **de2e45c**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Linux_image_ADI-scripts | :git-linux_image_ADI-scripts:`linux_image_ADI-scripts`                                            | main        | **2b8b630**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libiio                  | :git-libiio:`libiio`                                                                              | 2023_R2     | **bdd5c00**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | IIO-Osc                 | :git-iio-oscilloscope:`iio-oscilloscope`                                                          | 2023_R2     | **fbd5aa5**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libad9361-iio           | :git-libad9361-iio:`libad9361-iio`                                                                | 2023_R2     | **d692a52**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Libad9166-iio           | :git-libad9166-iio:`libad9166-iio`                                                                | 2023_R2     | **2916da3**         |
      ...
      | Wiki-scripts            | :git-wiki-scripts:`wiki-scripts`                                                                  | main        | **ded20fd**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Jesd-eye-scan-gtk       | :git-jesd-eye-scan-gtk:`jesd-eye-scan-gtk`                                                        | 2023_R2     | **90cad36**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Diagnostic_report       | :git-diagnostic_report:`diagnostic_report`                                                        | main        | **fc0ba06**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
      | Colorimeter             | :git-colorimeter:`colorimeter`                                                                    | 2023_R2     | **524674a**         |
      +-------------------------+---------------------------------------------------------------------------------------------------+-------------+---------------------+
