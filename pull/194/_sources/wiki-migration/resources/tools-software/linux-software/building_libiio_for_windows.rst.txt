...
.. note::
   ...
   You shouldn't really need to follow any of these instructions - the
   instructions are mainly there for libiio developers wanting to keeps some
   notes, so they remember how to do things.
...
-  Launch CMake, and specify the location of the source code, and the directory
...
-  Click on **Generate**.
   Now, CMake generated a Visual Studio solution file in the build directory,
   named "iio.sln". You can open this file with Visual Studio to build the
   project.
