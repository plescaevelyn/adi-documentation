...
This page will explain how you should go about formatting and flashing the SD
...
-  After the progress is at 100%, type 'assign' to finalize the drive letter for
   Windows.
...
.. important::
   ...
   If you are unsure, or don't understand these directions - STOP. If you are
   not careful, you could accidentally write a Linux image to your PC hard
   drive. Your PC will not function properly after this, and your IT department
   should not blame ADI.
...
.. warning::
   ...
   You DO NOT want to accidently re-image your hard drive, so this step is
...
-  Win32DiskImager will also alert you to make sure you want to write to this
   drive, acting as another failsafe so that you don't accidently image the
   wrong drive.
