...
ADI Kuiper Linux supports many platforms and development kits containing AMD(Xilinx) and Intel(Altera) FPGAs, as well as Raspberry Pi systems. Please click :doc:`here </wiki-migration/resources/tools-software/linux-software/kuiper-linux/project-list>` for a complete list of supported development kits and hardware projects.
...
SD Card Image and Release Notes
-------------------------------
...
If you are planning on imaging your own SD card, depending if you are using Linux or Windows, follow these instructions to write the image file to your SD card. *Return here after imaging the SD card*.
...
:doc:`Complete Project List </wiki-migration/resources/tools-software/linux-software/kuiper-linux/project-list>`
...
Many ADI hardware overlays are included with Kuiper Linux, for evaluation boards and reference designs. For a complete list of overlays for available hardware, please visit the :doc:`project list </wiki-migration/resources/tools-software/linux-software/kuiper-linux/project-list>`.
...
-  Ensure all the hardware jumpers and switches are set properly for the platform board to boot from SD card
-  Plug the ADI hardware into the correct connector according to the user guide of the board
...
:doc:`How to Build HDL </wiki-migration/resources/fpga/docs/build>`

:doc:`How to build Zynq kernel and device tree </wiki-migration/resources/tools-software/linux-build/generic/zynq>`

:doc:`How to build ZynqMP kernel and device tree </wiki-migration/resources/tools-software/linux-build/generic/zynqmp>`
