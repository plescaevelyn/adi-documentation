...
The EVAL-SD-KUIPERZ SD Card contains a pre-configured version ADI Kuiper Linux
intended for use with ACE and is included as part of the supported Product
