AD9543 Evaluation Board User Guide
==================================
...
-  AD9543 ACE Plug-in Module: `board.ad9543.1.1.8.zip <https://wiki.analog.com/_media/resources/eval/board.ad9543.1.1.8.zip>`_
-  Please only use ACE Software version 1.10.2671.1118. Do not update it to newer versions as they are not tested with the new AD9543 plug-in module
-  Install ACE first. Unzip the plug-in. Double click on it to have it installed

Documents Needed

-  :adi:`AD9543 Datasheet <media/en/technical-documentation/data-sheets/AD9543.pdf>`
...
The :adi:`AD9543` evaluation board is a compact, easy-to-use platform for evaluating all features of the :adi:`AD9543` dual digital PLL and IEEE 1588 synchronizer. The :adi:`AD9543` provides high-precision, multi-output clock generator functions, along with two on-chip jitter cleaning digital PLL cores. PLL0 and PLL1 are optimized for high performance synchronous clocking applications such as IEEE 1588 Version 2, Synchronous Ethernet, OTN, and next generation wireless baseband protocols. The PLLs are fully configurable via serial port control as well as configurable via an external EEPROM for power on ready configurations.
...
Refer to the Evaluation Board Software section for details on running the AD9543
evaluation board software.

Reference Inputs
~~~~~~~~~~~~~~~~

The :adi:`AD9543` evaluation board has four reference inputs sources. By default, REF A/AA (Connectors J300 and J301, respectively) have a transformer so that the user can use a signal generator and use REFA in differential mode.
...
The AD9543 board view can be seen in **Figure 3**. As the AD9543 evaluation platform is for a single component, the board view has only two main portions, as shown in **Figure 3**:
...
The chip view is the primary interface used to configure the AD9543. It consists
...
checking, and allows the user to intuitively configure the AD9543 parameters. It
should be noted that in order to synchronize the register content of the
software with that of the AD9543, the user must press the ‘Read All’ button in
...
.. container:: group
   ...
   .. container:: half column
      ...
      The configuration wizard simplifies configuring the AD9543 by providing
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad9543/ad9543top.jpg
   :width: 700
