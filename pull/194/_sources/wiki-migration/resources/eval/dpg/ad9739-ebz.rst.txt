...
This guide shows how AD9739-R2-EBZ works with SDP-H1 or ADS7-V2 controller board
...
-  Attach the evaluation board to the FMC connector of SDP-H1 or ADS7-V2 using
   ...
   Connect the evaluation board to PC via USB, a 5Vdc 2A power supply to J17.
...
-  Disconnect and reconnect the SDP-H1 /ADS7-V2 and AD9739 evaluation board.
