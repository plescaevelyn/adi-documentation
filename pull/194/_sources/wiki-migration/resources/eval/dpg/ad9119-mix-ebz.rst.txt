...
The AD9119-MIX-EBZ connects to a DPG2 to allow for quick evaluation of the
AD9119, a high-speed, RF Digital to Analog converter (RF DAC). The DPG2
automatically formats the data and sends it to the AD9119-MIX-EBZ, simplifying
evaluation of the device. The Evaluation Board (EVB) runs from +5 volt and -5
volt supplies. Figure 2 is an image of the top side of the AD9119 EVB.
...
Ensure that the program detects the AD9119, as indicated in the “Evaluation
...
Clock Out (DCO) frequency from the AD9119 should be reported in the Data Clock
...
The AD9119-MIX-EBZ is equipped with a wideband balun to enable operation in the
...
AD9119/AD9129 data sheet. Some of the registers and their functions are
described here as they pertain to the AD9119 evaluation board. Please note that
some of the screen images in this document may not match exactly with the latest
revision of the software, due to ongoing improvements and enhancements to the
software. The full screen layout is shown in Figure 13. The tabs can be seen
across the top of the work area, and a “READBACK” area is below the active tab
area. This READBACK section is present on each of the tabs, so that the user can
quickly assess status of the PLL and DLL lock, as well as parity and the FIFO
phase. Each of the tabs is discussed in its own section below.
...
.. container:: column
   ...
   down various blocks on the AD9119. These are associated with the power down
...
.. container:: column
   ...
   The Save/Load tab enables a different way of configuring the AD9119. The
