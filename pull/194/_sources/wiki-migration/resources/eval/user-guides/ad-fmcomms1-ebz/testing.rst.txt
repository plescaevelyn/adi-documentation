...
-  The test application is written in Linux - so you must have a Linux PC. If
   you don't:

   -  Install Ubuntu Linux
   -  Install required packages (gnuplot, glade).
   -  Since the date of manufacture is programmed into the boards, make sure
      that the day and time on the computer is set correctly.
...
-  Observe the LCD display: Make sure that the Serial number printed on Line2 reflects the value previously entered.
