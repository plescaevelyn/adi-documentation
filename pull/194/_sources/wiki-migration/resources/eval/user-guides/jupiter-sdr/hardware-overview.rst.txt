...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/jupitersdr_blockdiagram.png
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/jupitersdr_rf_fe_add-on.png
...
ADRV9002 external gain control functionality allows AGPIO pins configured as output to automatically set required front end gain. The software exposes required attributes that allows to manually control the AGPIO state.(:doc:`link to command example </wiki-migration/resources/eval/user-guides/jupiter-sdr/quickstart>`)
...
.. admonition:: Download
   ...
   -  `Rev C Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/02-048139-01-c.pdf>`_
...
.. |jupitersdr_front_panel.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/jupitersdr_front_panel.png
.. |jupitersdr_back_panel.png| image:: https://wiki.analog.com/_media/resources/eval/user-guides/jupiter-sdr/jupitersdr_back_panel.png
