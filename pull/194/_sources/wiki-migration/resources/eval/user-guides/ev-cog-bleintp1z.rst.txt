...
The following figure shows the orientation of the module. |image3| Pinout details of the module connector are given below.
...
.. admonition:: Download
   ...
   -  `Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/eval-cog-ad3029lz/02-046704-01-a-1_2_.pdf>`_ (PDF)
   -  `Bill of materials <https://wiki.analog.com/_media/resources/eval/user-guides/eval-cog-ad3029lz/05-046704-01-a.zip>`_ (zip)
   -  `Fabrication Files <https://wiki.analog.com/_media/resources/eval/user-guides/eval-cog-ad3029lz/09-046704-01a.zip>`_ (Zip)
