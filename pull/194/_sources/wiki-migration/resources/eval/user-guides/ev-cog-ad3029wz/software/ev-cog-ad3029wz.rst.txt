...
-  Downloaded via the tools program
   ...
   -  It is **recommended** to download the EV-COG-AD3029LZ software pack through from the tools program you are using. That way, all the files, directories structure, and project structure for the various applications is properly saved and accessed. For a detailed description on how to download the EV-COG-AD3029LZ software pack through CrossCore Embedded Studio please see our :doc:`CrossCore Embedded Studio Quickstart Userguide </wiki-migration/resources/eval/user-guides/ev-cog-ad3029lz/tools/cces_guide>`.
