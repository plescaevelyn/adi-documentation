...
-  An MCU *Cog* (such as the :doc:`EV-COG-AD3029WZ </wiki-migration/resources/eval/user-guides/ev-cog-ad3029wz/cog_hw_userguide>`) which has an on-board debugger and test-points for monitoring energy consumption.
