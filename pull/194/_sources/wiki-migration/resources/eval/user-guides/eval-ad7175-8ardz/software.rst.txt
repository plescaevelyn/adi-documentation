...
The EVAL-AD7175-8ARDZ evaluation kit includes a link to the software that needs
to be installed before using the EVAL-AD7175-8ARDZ evaluation board.
...
The chip view shows the block diagram of the AD7175-8. This tab allows the user
...
-  The functional block diagram of the AD7175-8 (Label 1 in Figure 7) shows each
   of the functional blocks within the AD7175-8. Clicking a functional block on
...
-  There are three external parameters that are set by the EVAL-AD7175-8ARDZ but
   ...
   (Label 6 in Figure 7). The external reference on the EVAL-AD7175-8ARDZ is set
