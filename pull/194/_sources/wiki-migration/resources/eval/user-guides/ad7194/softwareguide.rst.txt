...
After the AD7194 Plugin is downloaded follow the steps to install the file: -
Double click on the AD7194 Plugin. - Connect up your EVAL-AD7194ASDZ to your pc
through a controller board. Alternatively, the AD7194 Plugin can be installed
...
After the EVAL-AD7194ASDZ and controller board are properly connected to the PC,
launch the ACE software by taking the following steps:

-  From the Start menu of the PC, select All Programs > Analog Devices > ACE> ACE.exe to open the ACE software main window shown below
-  If the EVAL-AD7194ASDZ is not connected to the USB port via the controller
   board when the software launches, the AD7194 Eval Board icon does not appear
   in the Attached Hardware section in ACE (see Figure below).To make the
   AD7194Eval Board icon appear, connect the EVAL-AD7190ASDZ and the controller
...
-  Double click the AD7194 Eval Board icon to open the AD7194 Eval Board view
   window shown below:
...
-  The “Proceed to Analysis” button brings the user to the Analysis tab. This
   allows the user to see the performance results of the AD7194 and displays the
   data.
...
Use the Memory Map tab to access the registers of the AD7194, shown in the
...
-  Select the AD7194 by going to 'Precision ADC < 10MSPS' and finding the part
   there.
