...
The AD-T1LUSB2.0-EBZ board is an interface between USB 2.0 and a 10BASE-T1L
interface.
...
.. tip::
   ...
   \ Note: The AD-T1LUSB2.0-EBZ will send or receive data only over a
   FROFIBUS/SPE cable, so any design with a 10BASE-T1L interface will need to be
   powered separately.
...
When the AD-T1LUSB2.0-EBZ board is connected to a computer via a USB cable, a
new network interface should be available.
...
AD-T1LUSB2.0-EBZ board works as expected.
