...
-  An MCU *Cog* (such as the :doc:`EV-COG-AD4050LZ </wiki-migration/resources/eval/user-guides/eval-cog-ad4050lz/cog_hw_userguide>`) which has an on-board debugger and test-points for monitoring energy consumption.
