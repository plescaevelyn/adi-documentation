...
-  Downloaded via the tool chain's CMSIS pack manager
   ...
   -  It is **recommended** to download the ADuCM4x50 software pack through from the tool chain's CMSIS pack manager. That way, all the files, directories structure, and project structure for the various applications is properly saved and accessed. For a detailed description on how to download the ADuCM4x50 software pack through CrossCore Embedded Studio please see our :doc:`CrossCore Embedded Studio Quickstart Userguide </wiki-migration/resources/ev/user-guides/ev-cog-ad4050lz/tools/cces_guide>`.
