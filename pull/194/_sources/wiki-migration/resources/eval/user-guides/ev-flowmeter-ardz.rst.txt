...
The :adi:`EV-FLOWMETER-ARDZ` sensor is an advanced and efficient solution for flow measurement, suitable for utility and industrial applications. The ultrasonic time-of-flight technology, coupled with the integrated functions of the :adi:`MAX35101` time-to-digital converter, addresses the limitations of mechanical flow meters and offers improved accuracy and longevity.
...
-  :adi:`MAX3501 Product Page <en/products/max35101.html>`
...
.. admonition:: Download
   ...
   `EV-FLOWMETER-ARDZ Design Support Package <https://wiki.analog.com/_media/resources/eval/user-guides/ev-flowmeter_ardz-designsupport.zip>`_
