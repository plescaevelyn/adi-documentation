...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test.png
   :align: center
   :width: 600px

-  With the wizard expanded, select the noise test button (Label 1).

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_2.png
   :align: center
   :width: 300px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_3.png
   :align: center
   :width: 300px

-  The summary is then displayed once the write is complete.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_4.png
   :align: center
   :width: 200px

-  From here navigate to the chip view by double-clicking the AD417x chip (Label 1).

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_5.png
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_6.png
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/softwareprocedures/4170_ace_plugin_noise_test_page_7.png
   :align: center
   :width: 600px
