...
The board can be supplied from the AC input through an isolated AC/DC converter or from the USB through the :adi:`LTC3306`, a 1.75 A Synchronous Step-Down Regulator. A logic based on several :adi:`MAX40203`, an Ultra-Tiny nanoPower, 1 A Ideal Diodes with Ultra-Low-Voltage Drop, selects based on availability the supply input with priority to the AC input.

The other 1.1 V and 1.8 V voltage rails needed by the MCU are converted from the 3.3 V input by the :adi:`ADP225`, a Dual, 300 mA Adjustable Output, Quick Output Discharge, Low Noise, High PSRR Voltage Regulator.
...
-  T1L through the :adi:`ADIN1110`, an ultralow power, single port, 10BASE-T1L transceiver design for industrial Ethernet applications
-  RS-485 implemented using the :adi:`ADM2587E`, a 2.5 kV Signal and Power Isolated, ±15 kV ESD Protected, Full/Half Duplex RS-485 Transceiver (500 kbps)
-  Ethernet
...
For testing all the channels provided by the :adi:`ADE9430` the following setup can be used.
