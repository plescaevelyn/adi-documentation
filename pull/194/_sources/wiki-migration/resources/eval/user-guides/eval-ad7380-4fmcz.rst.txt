...
:adi:`EVAL-AD7380-4FMCZ` evaluation board Software download instructions

Equipment Needed
================

:adi:`EVAL-SDP-H1` kit Signal source PC running Windows XP SP3, Windows Vista, Windows 7, or Windows 10 with a USB port

Software Needed
===============

:adi:`ace-software` AD7380-4 ACE plugin :adi:`EVAL-SDP-H1` driver
