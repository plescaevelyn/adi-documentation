...
Questions about the MathWorks provided AD9361 simRF model, or the FMCOMMS2/3/4/5 Hardware support package can be asked either:
...
If you think you have a bug to report, the best place to to this is the Engineerzone (above). This way we can discuss if the bug is a bug, or a feature request, or just missing documentation.
