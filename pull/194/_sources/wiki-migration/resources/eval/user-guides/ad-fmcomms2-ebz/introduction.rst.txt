...
+-----------------------------------------------------------------+---------------+--------------+---------------------+---------------------+----------------------------------------------------------+-------------+
| :doc:`ADALM-PLUTO </wiki-migration/university/tools/pluto>`     | 1 x AD9363    | 1 x 1        | 1 (325 - 3800 MHz)  | 1 (325 - 3800 MHz)  | Active Learning Module                                   | HSMC        |
+-----------------------------------------------------------------+---------------+--------------+---------------------+---------------------+----------------------------------------------------------+-------------+
...
-  :doc:`Introduction </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/ad9361>` to the AD9361/AD9364
...
-  How to :doc:`simulate </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/software/simrf>` the part with `MathWorks RF Blockset (formerly SimRF) <https://www.mathworks.com/hardware-support/analog-devices-rf-transceivers.html>`_, to see if it is appropriate for your application
...
-  Create your own :doc:`custom HDL from Simulink </wiki-migration/resources/eval/user-guides/ad-fmcomms2-ebz/software/matlab_bsp>` and insert it into the ADI design to see how it works
