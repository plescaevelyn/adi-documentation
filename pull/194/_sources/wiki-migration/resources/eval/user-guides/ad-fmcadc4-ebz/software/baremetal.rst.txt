AD-FMCADC4-EBZ Bare Metal Quick Start Guide
===========================================
...
.. admonition:: Download
   ...
   -  AD-FMCADC4-EBZ Main Driver - :git-no-OS:`fmcadc4`
   -  Xilinx Platform Drivers - :git-no-OS:`common_drivers/platform_drivers`
   -  AD9680 Driver - :git-no-OS:`drivers/adc/ad9680`
   -  AD9528 Driver - :git-no-OS:`drivers/frequency/ad9528`
   -  ADC Core Driver - :git-no-OS:`common_drivers/adc_core`
   -  DMAC Core Driver - :git-no-OS:`common_drivers/dmac_core`
