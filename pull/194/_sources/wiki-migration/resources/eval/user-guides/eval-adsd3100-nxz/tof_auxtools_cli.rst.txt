...
-  In a command-line prompt execute **TOF_Evaluation_ADTF3175D-Rel5.0.0\\bin\\Python-setup\\aditofpython_env.bat**

Usage
"""""

-  In a command-line prompt execute **TOF_Evaluation_ADTF3175D-Rel5.0.0\\bin\\Python-setup\\Activate.bat**
...
This example using the Python PyGame engine to demonstrate streaming and visualization of ToF depth frames.
...
Parses the raw data of frame. This python tool takes the recorded raw frames and extracts the depth, AB confidence and point cloud data.

Depth frame, AB frame and confidence frame (if qmp mode) are saved as ``.png`` while point cloud data is saved as ``.ply``.

An ``.mp4`` file is also generated to show both AB and depth frames. Metadata of the recording is saved as a text file.
...
.. important::
   ...
   These tools has been removed from the host starting with Eval Kit version 5.0.0.
