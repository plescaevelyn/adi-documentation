...
-  `wethlink_installer.exe <https://swdownloads.analog.com/update/wethlink/latest/wethlink_installer.exe>`_
...
::
   ...
   $ git clone `wethlink <https://github.com/analogdevicesinc/wethlink>`_ # TODO: does not exist yet
   $ cd wethlink
