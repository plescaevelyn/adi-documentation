...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adbms2950-basic/eval-adbms2950-basicangle.jpg
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/adbms2950b.png
   :align: center
   :width: 600px
...
The EVAL-ADBMS2950-BASIC is equipped with a high-current bus bar style current sense resistor BAS-M-R00005-AE-5.0 from Isabellenhuette.
...
The EVAL-ADBMS2950-BASIC features 2 headers, J4 and J5, that make available the ADBMS2950B voltage inputs, GPO, GPIO and power outputs for probing and as additional inputs and outputs.
...
.. container:: indent
   ...
   **2kB On-Board EEPROM**
   ...
   .. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eeprom_on_board.png
      :align: center
      :width: 200px
   ...
   **isoSPI™ Connectors**
   ...
   The isoSPI™ DuraClik cable supplied with the EVAL-ADBMS2950-BASIC may be plugged into any of the connectors J8 or J9, marked isoA and isoB, respectively.
...
.. container:: indent
   ...
   **Common-mode Choke Bypass**
   ...
   Cut the bypass traces of the footprints for the common-mode chokes. In the board schematics, you can find these at CURRENT SENSE SHUNT > optional common mode filter.
   ...
   **TVS Protection Diodes**
   ...
   Unpopulated footprints for TVS diodes in SOT-23 package are located on the bottom layer of the EVAL-ADBMS2950-BASIC. The respective part in the schematics is located at CURRENT SENSE SHUNT > Optional TVS for remote shunt.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adbms2950-basic_connecting_high_voltage_input_clamps.png
   :align: center
   :width: 1000px
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/high_voltage_access-hv1_hv2_hv3.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/hv1_acess.png
   :width: 400px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/hv2_acess.png
   :width: 400px
.. |image4| image:: https://wiki.analog.com/_media/resources/eval/user-guides/hv3_acess.png
   :width: 400px
.. |image5| image:: https://wiki.analog.com/_media/resources/eval/user-guides/hvis01_acess.png
   :width: 400px
.. |image6| image:: https://wiki.analog.com/_media/resources/eval/user-guides/io_pins.png
   :width: 300px
.. |image7| image:: https://wiki.analog.com/_media/resources/eval/user-guides/oca_ocb_lv_domain.png
   :width: 400px
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/iso-spi.png
   :width: 400px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/attaching_cable_lugs_to_shunt_resistor.png
   :width: 600px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/attaching_cable_lugs_to_shunt_resistor_2.png
   :width: 600px
