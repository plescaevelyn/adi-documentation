...
.. important::
   ...
   | The latest version of this document can be found at https://analogdevicesinc.github.io/documentation/solutions/reference-designs/ad-max32lrwise-sl/ev-cattletag-ardz/index.html
...
When using the board, the power supply may come from different sources, and
these are listed below:

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/lora-reference-design/ev-cattletag-ardz_power_supply_input.png
   :align: center
   :width: 800

-  Solar Panel - use to recharge the lithium-ion connected to either P8 or to the 2x AAA battery. An example of a probe that can be used is a product from Anysolar and its datasheet can be found in `here <https://waf-e.dubudisk.com/anysolar.dubuplus.com/techsupport@anysolar.biz/O18Ae08/DubuDisk/www/Gen3/KXOB25-14X1F%20DATA%20SHEET%20202007.pdf>`_.
-  P6 Terminal block - external power source (e.g., solar panel)

.. important::

   When using an external power source, it is required to disconnect the
   on-board solar panel by removing the resistor R30\
...
.. important::
   ...
   When power supply directly from the host board is used, it is required to
   remove the R84 resistor and placed a 0 Ω resistor at R86\
