...
The necessary instructions on how to import **ADuCM360_demo_blink** project in your workspace can be found in the section, :doc:`Import a project into workspace </wiki-migration/resources/eval/user-guides/eval-adicup360/tools/cces_user_guide>`.
