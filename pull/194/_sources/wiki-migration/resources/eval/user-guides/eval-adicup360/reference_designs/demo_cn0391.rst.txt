...
system clock, enabling clock for peripherals; SPI read/write; for configuring
and reading from AD7124; UART read/write functions; calculation algorithm for
cold junction and linearized thermocouple temperature.
