...
The **ADuCM360_demo_cn0394** is a temperature measurement demo project which used thermocouple principle of measurement with the EVAL-ADICUP360 base board with additional :adi:`EVAL-CN0394-ARDZ shield <cn0394>`, created using the GNU ARM Eclipse Plug-ins in Eclipse environment.

General description
-------------------

The **ADuCM360_demo_cn0394** project uses the :adi:`EVAL-CN0394-ARDZ shield <cn0394>`, which is a multichannel thermocouple temperature measurement system with cold junction compensation.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/reference_designs/cn0394/cn0394_demo_1.png
   :align: left
   :width: 650
...
-  **RTD channel calibration** - *USE_RTD_CALIBRATION* parameter - enable/disable calibration on RTD channel - *YES* -> enable calibration; *NO* -> disable calibration(*CN0394.h*).
-  **Thermocouple channel calibration** - *USE_TH_CALIBRATION* parameter - enable/disable calibration on thermocouple channel - *YES* -> enable calibration; *NO* -> disable calibration(*CN0394.h*).
-  **Terminal refresh** - *DISPLAY_REFRESH* parameter - how often to refresh the output data - input time value in [msec] (*CN0394.h*).
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup360/reference_designs/cn0394/cn0394_demo_3.png
   :align: left
   :width: 300
