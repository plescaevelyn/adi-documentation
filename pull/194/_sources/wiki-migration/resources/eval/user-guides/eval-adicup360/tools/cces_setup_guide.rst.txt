...
This page provides all the necessary steps to get CrossCore Embedded Studio (CCES) :adi:`CrossCore Embedded Studio <en/design-center/evaluation-hardware-and-software/software/adswt-cces.html>` software environment up and running on Windows or Linux.
...
-  Eclipse based IDE
-  GNU ARM Embedded Toolchain for Cortex-M core based parts (6-2017-q2-update release)
...
-  Compilation using the GNU ARM Embedded toolchain for the ADuCM360 ARM Cortex-M3 core.
-  Debugging ADuCM360 via the IDE with GDB/OpenOCD.
-  Development and debugging of bare-metal applications on the ADuCM360 Cortex-M3 core.
