...
Download the ACE software from the ACE software page or the AD7193 product page. Install ACE on a PC **before using** the EVAL-AD7193ASDZ.
...
After the AD7193 Plugin is downloaded follow the steps to install the file: - Double click on the AD7193 Plugin. - Connect up your EVAL-AD7193ASDZ to your pc through a controller board. Alternatively, the AD7193 Plugin can be installed through the steps bellow:
...
-  Under Source hit the … button and set the path to where you have stored the AD7193 Plugin.
-  Press “Ok”.
-  Press “Close”.
...
After the EVAL-AD7193ASDZ and controller board are properly connected to the PC, launch the ACE software by taking the following steps:

-  From the Start menu of the PC, select All Programs > Analog Devices > ACE> ACE.exe to open the ACE software main window shown below
-  If the EVAL-AD7193ASDZ is not connected to the USB port via the controller board when the software launches, the AD7193 Eval Board icon does not appear in the Attached Hardware section in ACE (see Figure below).To make the AD7193 Eval Board icon appear, connect the EVAL-AD7193ASDZ and the controller board to the USB port of the PC, wait a few seconds, and then follow the instructions in the dialog box that opens.

|image10|

-  Double click the AD7193 Eval Board icon to open the AD7193 Eval Board view window shown below:|image11|
-  Double click the AD7193 chip icon in the AD7193 Eval Board view window to open the AD7193 chip view window shown below:
-  Click Software Defaults and then click Apply Changes to apply the default settings to the AD7193 (see figure below)\
...
After completing the steps in the :doc:`Software Installation Procedures </wiki-migration/resources/eval/user-guides/ad7193/softwareprocedures>` section and the :doc:`Evaluation Board Set-up Procedures </wiki-migration/resources/eval/user-guides/ad7193/hardwareguide>` section, set up the system for data capture by taking the following steps:
...
-  The “Proceed to Memory Map” button brings the user to the memory map of the AD7193. This allows the user to configure the AD7193.
-  The “Proceed to Analysis” button brings the user to the Analysis tab. This allows the user to see the performance results of the AD7193 and displays the data.
...
Use the Memory Map tab to access the registers of the AD7193, shown in the figure below. This tab changes register settings and shows additional information about each bit in each individual register.
...
-  Select the AD7193 by going to 'Precision ADC < 10MSPS' and finding the part there.
...
:doc:`Previous Page: Hardware Guide </wiki-migration/resources/eval/user-guides/ad7193/hardwareguide>`
...
.. |image8| image:: https://wiki.analog.com/_media/resources/eval/user-guides/AD4170/softwareprocedures/4170_ace_plugin_install_page_1.png
   :width: 400px
.. |image9| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/ad7193aceplugin.png
   :width: 400px
.. |image10| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/ad7193attachhardware.png
   :width: 400px
.. |image11| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/ad7193boardview.png
   :width: 400px
.. |image12| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/ad7193chipview.png
   :width: 400px
