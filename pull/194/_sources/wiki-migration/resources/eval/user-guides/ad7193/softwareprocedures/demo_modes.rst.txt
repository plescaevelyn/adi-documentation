...
If you have not set up the EVAL-AD7193ASDZ and controller board previously please go to the :doc:`Quick Start Guide </wiki-migration/resources/eval/user-guides/ad7193>`

If you have not set up/installed the ACE plugin before please go to :doc:`Install Guide </wiki-migration/resources/eval/user-guides/ad7193/softwareprocedures>`

-  Double click the AD7193 Eval Board icon to open the AD7193 Eval Board view window. The demo wizard will be on the left, either as shown in the figure below (Label 1) or already expanded. Expand the wizard by clicking the arrow (Label 2).\


|image1|

-  With the wizard expanded, select the noise test button (Label 3).
-  The settings required for the demo are displayed to be viewed prior to writing to the AD7193 (Label 4). Click apply (Label 5) to write these settings to the board.
-  The summary is then displayed once the write is complete (Label 1).\

|image2|

-  From here navigate to the chip view by double-clicking the AD7193 chip (Label 2).
...
-  For more information on the Waveform window go to the software section :doc:`here </wiki-migration/resources/eval/user-guides/ad7193/softwareprocedures>`
...
-  The value in the Refin1(+/−) field on the Configuration tab is set to 2.5 V by default to use the external 2.5 V on-board reference (ADR4525). If a different reference is used to the AD7193, the Refin1(+/−) field should be updated accordingly. (The analysis results are based on the value set in this input field.)

   -  Information on the reference choice can be viewed in the :doc:`Reference Options Tab </wiki-migration/resources/eval/user-guides/ad7193/hardwareguide>`
...
:doc:`Return to Software Guide </wiki-migration/resources/eval/user-guides/ad7193/softwareprocedures>`

.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/softwareprocedures/ad7193board_view.png
   :width: 600px
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/softwareprocedures/ad7193_noise_test_summary.png
   :width: 600px
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7193/softwareprocedures/ad7193_noise_chipview.png
   :width: 600px
