...
-  HB100 Casing (to be printed; see instructions in the `#hardware_setup <https://wiki.analog.com/>`_ section below)
...
**Casing**: Download and 3D print the HB100 casing `HB100 Holder Step File <https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0566/hb100_holder.zip>`_. This casing includes a 1/4-20 thread, which is standard for camera mounts or tripods.
