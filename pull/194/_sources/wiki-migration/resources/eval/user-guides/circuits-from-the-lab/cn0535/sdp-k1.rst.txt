...
The following sections on setup describe the steps for setting up the CN0535 board using the :adi:`SDP-K1` and the `mbed Example program for CN0535-FMCZ <https://os.mbed.com/teams/AnalogDevices/code/EVAL-CN0535-FMCZ>`_.
...
The following sections describe the process of setting up the hardware for both the :adi:`SDP-K1` micro-controller board and the :adi:`EVAL-CN0535-FMCZ <en/design-center/reference-designs/circuits-from-the-lab/cn0535.html#rd-overview>` customer evaluation board.

EVAL-CN0535-FMCZ Prep for use with SDP-K1
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The EVAL-CN0535-FMCZ was designed :adi:`to be evaluated <en/design-center/reference-designs/circuits-from-the-lab/cn0535.html#rd-commonvariations>` using :adi:`SDP-H1`. On the other hand, if the user want to evaluate the CN0535 using :adi:`SDP-K1`, the following components needs to be installed. The table below shows the components that the user must install to enable the use of the EVAL-CN0535-FMCZ with the SDP-K1.
...
|image3| Note: For SDP-K1 Rev E and Below, a 6V wall-wart power is needed on P15.
...
-  After having a acount, open the Example program for EVAL-CN0535-FMCZ https://os.mbed.com/teams/AnalogDevices/code/EVAL-CN0535-FMCZ/
...
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 1.  | Set LTC6373 PGIA Gain/Mode                   | Change the :adi:`LTC6373` Gain or Mode. The available option are Shutdown mode and gains of 0.25 V/V, 0.5 V/V, 1 V/V, 2 V/V, 4 V/V, 8 V/V, 1 6V/V.                                                                          |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2.  | Set ADA4945 FDA Power Mode                   | Change the :adi:`ADA4945` Power Mode to:Full Power Mode or Low Power Mode .                                                                                                                                                 |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3.  | Set AD7768-1 power mode                      | Change the :adi:`AD7768-1` to Low, Median or Fast. Low power mode is recommended.                                                                                                                                           |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4.  | Set AD7768-1 MCLK clock divider              | Change the :adi:`AD7768-1` clock divider to: /16, /8, /4 or /2. /16 is recommended.                                                                                                                                         |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5.  | Set AD7768-1 filter type                     | Change the :adi:`AD7768-1` filter type used. Also allows for the oversampling ratio to be changed. Recommended is the Low ripple FIR Filter, oversampled by 32.                                                             |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 7.  | Set AD7768-1 REF buffers                     | Adjust the :adi:`AD7768-1` buffers for both REF+ and REF-. It is recommended to turn on both REF+ and REF- precharge REF buffers.                                                                                           |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 8.  | Set AD7768-1 VCM output                      | Choose the :adi:`AD7768-1` VCM output voltage, recommended is (AVDD1 – AVSS)/2.                                                                                                                                             |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 11. | Set AD7768-1 Gains and Offsets               | Set :adi:`AD7768-1` Gain and Offset register.                                                                                                                                                                               |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 12. | Read AD7768-1 master status                  | Shows faults in :adi:`AD7768-1` master status register, allowing the user to pinpoint the source of problems.                                                                                                               |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 13. | Read AD7768-1 desired register               | Reads desire :adi:`AD7768-1` register.                                                                                                                                                                                      |
+-----+----------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0535/board_top.png
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0535/board_bot.png
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/user-guides/circuits-from-the-lab/cn0535/setup_block_diagram2.png
