...
-  **ADXL355 no-OS Driver**
   ...
   -  The :doc:`ADXL355 no-OS driver </wiki-migration/resources/tools-software/uc-drivers/adxl355>` is used in bare-metal applications, typically running on low-power, embedded microcontrollers.
...
The \*\* EVAL-ADXL355-PMDZ \*\* can be used with :doc:`ADICUP3029 </wiki-migration/resources/eval/user-guides/eval-adicup3029>`.
...
2. Connect a micro-USB cable to the P10 connector of the EVAL-ADICUP3029 and connect it to a computer. The final setup should look similar to the picture below. |adxl355_adicup3029_connections.jpg| *<fc>Figure 5. Hardware Setup*

3. Make sure the following switches are as shown from the table below. |switch_config.png| *<fc>Figure 6. Switch Confuguration*
...
-  \*\* Hardware \*\*
   ...
   -  `MAX32655FTHR <https://www.maximintegrated.com/MAX32655FTHR>`_ or `MAX32650FTHR <https://www.maximintegrated.com/MAX32650FTHR>`_ with `MAX32625PICO <https://www.maximintegrated.com/MAX32625PICO>`_
   -  :adi:`FTHR-PMD-INTZ`
   -  :adi:`EVAL-ADXL355-PMDZ`
   -  Micro-USB to USB Cable
   -  10-pin ribbon cable
...
1. Using a 10-pin ribbon cable, connect the **MAX32625PICO** to the **MAX32650FTHR**. |image3| 2. Connect **MAX32650FTHR** to the **FTHR-PMOD-INTZ**.
...
In order to boot the Raspberry Pi and control the **EVAL-ADXL355-PMDZ**, you will need to install ADI Kuiper Linux on an SD card. Complete instructions, including where to download the SD card image, how to write it to the SD card, and how to configure the system are provided on the :doc:`Kuiper Linux page </wiki-migration/resources/tools-software/linux-software/kuiper-linux>`.
...
<code> D:\\pyadi-iio\\examples>python adxl355_example.py </code>
