...
\*\* 1.2*\* In Matlab current folder list select navigate to the folder where
...
e.g. <code> hdlsetuptoolpath(‘ToolName’, ‘Xilinx Vivado’, ’ToolPath’,
‘</opt/Xilinx/Vivado/2021.1/bin/vivado>’) </code>
...
-  IP DATA <x> OUT is the data in offset binary format sent to the DAC interface
   IP. Data must be sent at 15MSPS when both channels are enabled or at 30MSPS
