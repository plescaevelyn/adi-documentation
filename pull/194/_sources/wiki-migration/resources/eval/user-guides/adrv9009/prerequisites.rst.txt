Prerequisites for ADRV9009 based boards
=======================================

What you need, depends on what you are trying to do. As a minimum, you need to start out with:

-  The ADRV9009 based card.
-  A carrier platform. ADI does not offer these boards for sale or loan, getting one yourself is normal part of development or evaluation of the ADRV9009. Our recommended carriers (the ones we use all the time) are either:
