...
.. admonition:: Download
   ...
   A concise version of this document is also available in portable document format: `AD-BMSE2E3W-SL QuickStart Guide (pdf) <https://wiki.analog.com/_media/resources/eval/user-guides/ad-bmse2e3w-sl-ug-2245.pdf>`_
...
+-----------------------------------------+------+---------+------+------+-------------------------------------------------------------------+
| Total Supply Voltage, V+ to V−          | -0.3 |         | 85   | V    | 6830 chip's total supply rating                                   |
+-----------------------------------------+------+---------+------+------+-------------------------------------------------------------------+
...
.. admonition:: Download
   ...
   `AD-BMSE2E3W-SL Design & Integration Files <https://wiki.analog.com/_media/resources/eval/user-guides/ad-bmse2e3w-sl/ad-bmse2e3w-sl-designsupport.zip>`_
