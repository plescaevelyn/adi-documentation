...
The **ADuCM_demo_cn0503** project uses **EVAL-CN0503-ARDZ** to provide a method to determine properties of liquids, for example turbidity, fluorescence and pH. To do this the application must configure the :adi:`ADPD4101` sensor, read the data from it and perform calculations on the data to improve **SNR** and pre-processes it to units as close to the desired measurement as possible.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0503_data_gather.png
   :align: center
...
-  Hardware
   ...
   -  3D printed mechanical fixtures described in the :doc:`Hardware User Guide </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0503>`
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0503_main.png
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0503_intialization.png
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adicup3029/reference_designs/cn0503_main_process.png
   :align: center
...
-  Use example scripts from :git-EVAL-ADICUP3029:`this folder <projects/ADuCM3029_demo_cn0503/scripts>` and see the :git-EVAL-ADICUP3029:`readme file <projects/ADuCM3029_demo_cn0503/scripts/README.md>` to learn how to use them.

Hardware User Guide and Demo Guides
-----------------------------------

-  :doc:`EVAL-CN0503-ARDZ Hardware User Guide </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0503>`
-  :doc:`Optical Platform: Fluorescence Measurement Demo (ADICUP3029 + EVAL-CN0503-ADRZ) </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0503/fluorescence>`
-  :doc:`Optical Platform: pH Measurement Demo (ADICUP3029 + EVAL-CN0503-ADRZ) </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0503/colorimetry>`
-  :doc:`Optical Platform: Turbidity Measurement Demo (ADICUP3029 + EVAL-CN0503-ADRZ) </wiki-migration/resources/eval/user-guides/circuits-from-the-lab/cn0503/turbidity>`
