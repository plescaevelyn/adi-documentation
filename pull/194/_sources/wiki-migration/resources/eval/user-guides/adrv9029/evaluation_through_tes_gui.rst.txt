...
-  Program the device by selecting Usecase = 51_nonLinkSharing in the Overview Tab of the ADRV9029 TES GUI, turn on the power amplifier and verify that the Transmitter is functioning correctly as described in the :adi:`ADRV902x unboxing video <en/products/adrv9029.html#product-reference>`. A couple of things to note before programming the device
   ...
   -  Ensure that the LO frequency matches the operating frequency range of the
      ...
      same LO as transmitters(ObsRxLO = TxLO).
      Also, ensure the Tx to ORx mapping selection is correct. Typically, a one
      to one Tx-ORx mapping is used as shown in the figure below.
...
-  Ensure that the Observation Receiver is not saturating by adjusting the ORx
   ...
   of 11.5 dB on the ORx front end. A gain index of 255 provides 0dB attenuation
   and decrementing the gain index by 1 increases the attenuation by 0.5dB.

|resources-eval-user-guides-adrv9029-adrv9029_orx_setup.png|

-  Bring the Power Amplifier to it's rated power by adjusting the ADRV9029 Tx
