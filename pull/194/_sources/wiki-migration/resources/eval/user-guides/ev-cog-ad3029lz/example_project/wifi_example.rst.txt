...
The ESP8266 WiFi module is plugged into the P9 port of the EV-COG-BLEINTP1Z board ( Refer Hardware Details section 2,EV-COG-BLEINTP1Z Connectivity Cog - WiFi Module connector section :doc:`ev-cog-bleintp1z </wiki-migration/resources/eval/user-guides/ev-cog-bleintp1z>` ).EV-Cog-AD3029LZ communicates to ESP8266 WiFi module through AT commands over UART interface.
...
.. admonition:: Download
   ...
   `wifi_software_users_guide.pdf <https://wiki.analog.com/_media/resources/eval/user-guides/ev-cog-ad3029lz/example_project/wifi_software_users_guide.pdf>`_
