...
-  ADXUD1AEBZ Rev. D Design:
   ...
   -  `Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/02-065073-01-d.pdf>`_
   -  `Bill of Materials <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/xud1a_bom.zip>`_

-  Interposer Board Rev. A Design:

   -  `Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/02-067148-01-a.pdf>`_
   -  `Bill of Materials <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/interposerbom.zip>`_

-  Interposer Board Rev. B Design:

   -  `Schematic <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/02-067148-01-b.pdf>`_
   -  `Bill of Materials <https://wiki.analog.com/_media/resources/eval/user-guides/xud1a/interposerbom-b.zip>`_
