...
.. admonition:: Download
   ...
   -  `Compressed 3D Model .DXF file <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/talisecarrier.zip>`_
   -  `Compressed 3D Model .STP file <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/adrv2crr_3d.zip>`_
   -  `Compressed 3D Model Rev C .STP file <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/08_048950c.zip>`_
...
.. admonition:: Download
   ...
   -  `Rev C.1 Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009-zu11eg/02-048950-01-c2_1_.pdf>`_
   -  `Rev C.1 BOM <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009-zu11eg/rev_c.1_bom.zip>`_
   -  `Rev C to Rev C.1 Errata <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009-zu11eg/revc_to_revc.1_errata.xlsx>`_
   -  `Letter of Volatility <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009-zu11eg/letter_of_volatility_adrv2crr-fmc_carrier_board.pdf>`_
...
.. admonition:: Download
   ...
   -  `Rev C Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/02-048950-01-c.pdf>`_
   -  `Rev C BOM <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/05-048950-01-c.zip>`_
   -  `Rev B/C BRD File <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/08_048950c_BRD.zip>`_
   -  `Rev C Board Design Files <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/20_048950c_archive.zip>`_
...
.. admonition:: Download
   ...
   -  `Rev B Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/carrier_board_02_048950b_top.pdf>`_
...
.. admonition:: Download
   ...
   -  `Rev A Schematics <https://wiki.analog.com/_media/resources/eval/user-guides/adrv9009_zu11eg/carrier_board_02_048950a_top.pdf>`_
