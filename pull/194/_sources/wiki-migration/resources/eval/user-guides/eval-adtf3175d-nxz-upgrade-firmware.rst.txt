...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adtf3175d-nxz/adi-tof-firmware-update-1.png
   :align: center
...
-  Run the following command, using the appropriate firmware filename:
   ...
   -  Pre-5.0.0 ``data_collect.exe --ip 10.42.0.1 --fw firmware_upgrade_xxxx.bin tof-viewer_config.json``
   -  5.0.0 ``data_collect.exe --ip 10.43.0.1 --fw Fw_Update_x.y.z.bin config_adsd3500_adsd3100.json``
