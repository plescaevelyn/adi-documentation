...
This page provides a high level overview of the :doc:`EVAL-ADTF3175-NXZ </wiki-migration/resources/eval/user-guides/eval-adtf3175-nxz>` evaluation platform. This system is showcases the ADTF3175 ToF module.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adtf3175-nxz/nxp_carrier.png
   :align: center
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-adtf3175-nxz/hostpc.png
   :align: center

SDK
~~~

An open source SDK for this evaluation platform is provided on :git-ToF:`ToF`. The SDK also requires the depth compute libraries which are provided as binaries in the installer @ ` <https://github.com/analogdevicesinc/ToF/releases/>`__.
