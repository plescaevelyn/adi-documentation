...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-top.png
   :alt: EVAL-LTPA-COMPRB (Top)
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-hardware-interface.png
   :alt: EVAL-LTPA-COMPRB Hardware Interface
   :align: center
   :width: 1200px
...
3. Setup the LTpowerAnalyzer hardware, ADALM2000, and the DUT for Bode Plot measurement. Refer to the `EVAL-LTPA-KIT User Guide <https://wiki.analog.com/eval-ltpa-kit>`_ for detailed instructions. Remember to connect a DC power supply to the DUT input.
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-control-panel.png
   :alt: COMPRB Control Panel
   :align: center
   :width: 1400px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-bode-plot-example.png
   :alt: COMPRB Bode Plot Example
   :align: center
   :width: 1400px
...
A hardware setup of the compensation probe is shown below for reference. This example uses the LT8642S demo board included with the EVAL-LTPA-KIT as the device under test.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-example-application.png
   :alt: COMPRB Example Application 1
   :align: center
   :width: 600px
...
If the Compensation Probe is connected properly, the resulting Bode plots should be very similar to what would be captured had the compensation resistor and capacitor been soldered directly to the DUT. The following example Bode plots illustrate this at different compensation resistances for the LT8642S:

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-bode-plot-comparison-13k.png
   :alt: COMPRB Bode Plot Comparison 13k
   :align: center
   :width: 600px

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-bode-plot-comparison-26k.png
   :alt: COMPRB Bode Plot Comparison 26k
   :align: center
   :width: 600px

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-bode-plot-comparison-52k.png
   :alt: COMPRB Bode Plot Comparison 52k
   :align: center
   :width: 600px

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-bode-plot-comparison-100k.png
   :alt: COMPRB Bode Plot Comparison 100k
   :align: center
   :width: 600px
...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-resistance-error.png
   :alt: COMPRB Resistance Error
   :align: center
   :width: 600px

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-ltpa-comprb/eval-ltpa-comprb-capacitance-error.png
   :alt: COMPRB Capacitance Error
   :align: center
   :width: 600px
