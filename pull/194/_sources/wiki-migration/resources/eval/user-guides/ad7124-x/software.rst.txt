...
The Configuration tab (Label 1) shows a block diagram of the AD7124-8. It allows
the user to set up the ADC, reset the ADC, read the diagnostics to view errors
present, as well as configure the device for different demo modes. The
Configuration tab is shown in more detail below, along with explanations of the
