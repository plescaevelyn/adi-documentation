...
All changes required for RPi are applicable to Nvidia Xavier AGX. So please follow the instructions presented here: :doc:`Raspberry Pi User Guide </wiki-migration/resources/eval/user-guides/ad-96tof1-ebz/ug_rpi>`
...
-  connect the 19V power supply to the Xavier AGX. Once power is connected to the Xavier AGX the system will boot the Linux OS from the SD card.
...
.. admonition:: Download
   ...
   **Nvidia Xavier AGX interposer design and manufacturing files**
   ...
   -  `Design files <https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tof1-ebz/08_065345a.zip>`_
   -  `Gerber files <https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tof1-ebz/nvidia_agx_xavier_interposer.zip>`_
