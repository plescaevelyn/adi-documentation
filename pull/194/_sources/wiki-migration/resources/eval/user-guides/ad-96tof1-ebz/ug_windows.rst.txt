...
.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad-96tof1-ebz/windows_db410c_usb.jpg
   :alt: Windows driver
   :align: center
   :width: 300px
...
-  For **first-frame-ethernet** example, if the IP address of the target is *192.168.1.110* the run command should be: ``first-frame-ethernet.exe "192.168.1.110"``
