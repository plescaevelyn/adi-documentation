...
-  :doc:`SDP to FMC Interposer </wiki-migration/resources/eval/sdp/sdp-fmc>`
...
To boot the Zedboard and control the :adi:`EVAL-AD2S1210SDZ`, you will need to install ADI Kuiper Linux on an SD card. Complete instructions, including where to download the SD card image, how to write it to the SD card, and how to configure the system are provided on the :doc:`Kuiper Linux page </wiki-migration/resources/tools-software/linux-software/kuiper-linux>`.
