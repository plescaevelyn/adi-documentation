...
-  IFM and PCB Piezotronics provide magnetic mounts with M8 or ¼-28 vibration
   ...
   -  Note: To use the IFM base then you also need a ¼-28 to M8 adaptor stud for
      the Voyager enclosure
...
-  PCB Piezotronics ¼-28. Example Parts:
   ...
   -  Note: The Piezotronics bases 080A54, 080A130/131/132 could be used
      directly with the Voyager enclosure concept, as they include a ¼-28
      treaded hole.
