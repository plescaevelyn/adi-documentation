...
Refer to the Evaluation Board Software section for details on running the AD9545
evaluation board software.

Reference Inputs
~~~~~~~~~~~~~~~~

The AD9545 evaluation board has four reference inputs sources. By default, REF
A/AA (Connectors J300 and J301, respectively) have a transformer so that the
user can use a signal generator and use REFA in differential mode.
...
Use the following instructions to set up the AD9545 evaluation board software.
...
The chip view is the primary interface used to configure the AD9545. It consists
...
checking, and allows the user to intuitively configure the AD9545 parameters. It
should be noted that in order to synchronize the register content of the
software with that of the AD9545, the user must press the ‘Read All’ button in
...
.. container:: group
   ...
   .. container:: half column
      ...
      The configuration wizard simplifies configuring the AD9545 by providing
