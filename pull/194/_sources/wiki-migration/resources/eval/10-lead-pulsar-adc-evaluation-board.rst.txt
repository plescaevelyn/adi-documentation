...
`Evaluation Board Software version 1.1 <https://wiki.analog.com/_media/resources/eval/10_lead_pulsar_rev_a_gerbers.zip>`_ is available to download.
...
`Schematic in .pdf format <https://wiki.analog.com/_media/resources/eval/10_lead_pulsar_reva.pdf>`_

`Schematic in Mentor Graphics Pads format 9.3 <https://wiki.analog.com/_media/resources/eval/10_lead_pulsar_reva_pads_schematic.zip>`_

`Layout in Mentor Graphics Pads Layout <https://wiki.analog.com/_media/resources/eval/10_lead_pulsar_reva_pads_layout.zip>`_

Gerber Files
------------

`10_lead_pulsar_rev_a_gerbers.zip <https://wiki.analog.com/_media/resources/eval/10_lead_pulsar_rev_a_gerbers.zip>`_
