...
Use the following instructions to set up the AD9542 evaluation board software. Do not connect the evaluation board until the software installation is complete.
