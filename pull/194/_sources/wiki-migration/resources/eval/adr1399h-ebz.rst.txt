Evaluation Board for the ADR1399 Ultra Stable Shunt Voltage Reference in TO-46
==============================================================================
...
**EVALUATION KIT CONTENTS** ADR1399H-EBZ
...
**GENERAL DESCRIPTION** The ADR1399H-EBZ allows the evaluation of the ADR1399KHZ, ultra-stable 7.05V Shunt Voltage Reference in 4-lead TO-46 package.

The DUT is elevated on its leads in order to increase the thermal isolation from
the 4-layer board ground planes.
...
The ultra-stable 7.05V is brought out to both banana jacks and to an edge
...
INITIAL BOARD CONFIGURATION The ADR1399H-EBZ comes pre-configured. There are no
...
Figure 5. ADR1399H-EBZ Schematic, USB Conditioning, Isolated Power, and
Regulator Sections

|image3|

ORDERING INFORMATION BILL OF MATERIALS Table 1.
...
.. |image1| image:: https://wiki.analog.com/_media/resources/eval/adr1399.jpg
   :width: 400
.. |ADR1399H| image:: https://wiki.analog.com/_media/resources/eval/adr1399a.png
   :width: 400
.. |image2| image:: https://wiki.analog.com/_media/resources/eval/adr1399b.png
   :width: 400
.. |image3| image:: https://wiki.analog.com/_media/resources/eval/adr1399c.png
   :width: 400
