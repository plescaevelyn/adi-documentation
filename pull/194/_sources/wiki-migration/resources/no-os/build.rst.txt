...
.. collapsible:: Mbed (Click to expand)
   ...
   -  Configure the compiler location with Mbed CLI. This can be carried out by
      running the "mbed config -G GCC_ARM_PATH "path-to-your-gcc-compiler"" in
      Command Prompt.
...
.. collapsible:: Mbed (Click to expand)
   ...
   .. important::
      ...
      enclosed in parenthesis appears in the git terminal) and that the packages
...
.. collapsible:: STM32 (Click to expand)
   ...
   Assuming you've installed STM32CubeMX at C:\\stm32cubemx and STM32CubeIDE to
