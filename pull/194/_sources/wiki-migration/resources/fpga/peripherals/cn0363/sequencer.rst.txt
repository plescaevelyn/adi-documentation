...
| Name                                                                                                                         | Description                                                                 |
+==============================================================================================================================+=============================================================================+
| `cn0363_dma_sequencer.v <https://github.com/hdl?dev/library/cn0363/cn0363_dma_sequencer/cn0363_dma_sequencer.v>`_            | Verilog source for the peripheral.                                          |
+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
| `cn0363_dma_sequencer_ip.tcl <https://github.com/hdl?dev/library/cn0363/cn0363_dma_sequencer/cn0363_dma_sequencer_ip.tcl>`_  | TCL script to generate the Vivado IP-integrator project for the peripheral. |
+------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+
...
+-----------------------+------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
| ``dma_wr``            | `FIFO Write Interface <https://wiki.analog.com/../interfaces/fifo_wr_interface>`_ master | Low-level SPI bus interface that is controlled by peripheral.                   |
+-----------------------+------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+
