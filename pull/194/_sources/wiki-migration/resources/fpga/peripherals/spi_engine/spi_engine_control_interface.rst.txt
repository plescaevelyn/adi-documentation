...
-  The SDO stream which carries the to be transmitted data for the SPI bus. (Master to Slave)
...
| Name                                                                                                              | Description               |
+===================================================================================================================+===========================+
| `spi_engine_ctrl_rtl.xml <https://github.com/hdl?master/library/spi_engine/interfaces/spi_engine_ctrl_rtl.xml>`_  | Interface definition file |
+-------------------------------------------------------------------------------------------------------------------+---------------------------+
