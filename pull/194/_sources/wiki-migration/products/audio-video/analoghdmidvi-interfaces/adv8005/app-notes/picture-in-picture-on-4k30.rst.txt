...
The OSD bandwidth varies as per each region size which is better calculated
using Blimp’s emulator. Bandwidth maximum is calculated per video line. Of
course overlapping regions can double the bandwidth for a video line.
