...
Description of the ADALM2000 calibration API in :doc:`libm2k </wiki-migration/university/tools/m2k/libm2k/libm2k>`.
...
The file can be generated by using the following :git-libm2k:`script <bindings/python/calibration/generate_temperature_calib_lut.py>`. For better result, please consider exposing ADALM2000 to wider temperature variations, while the file is generated - will generate calibration values for more diverse points.
