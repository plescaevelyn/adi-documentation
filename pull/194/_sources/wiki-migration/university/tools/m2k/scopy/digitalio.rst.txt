...
.. image:: https://wiki.analog.com/_media/university/tools/m2k/scopy/scopy_2018-05-15_16-46-33.png
   :align: center

-  Digital channel number - the physical pin of the M2K
-  Channel input state - indicates the input read by the M2K
-  Channel direction - indicates whether the channel is set to input/output
-  Channel output state - indicates the output value configured of the M2K
