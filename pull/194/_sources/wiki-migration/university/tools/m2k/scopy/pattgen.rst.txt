...
|image1| The buttons on top of the pattern generator are:
...
The user can enable channels by clicking the blue checkbox button, setting the channel as an output. By double clicking the channel the channel settings for it will be shown |image3| In the channel settings the name, trace height are displayed. If the channel is part of a group, then the channels in the group are shown and can be removed by clicking the red X button or changed in order using the drag widget. The pattern for this channel/ channel group can be changed and the corresponding pattern settings are displayed. To group a set of channel the same mechanism as in the Logic Analyzer is used. Click the group button (it becomes "done") select all the channels you want to have in a group, then click the done button. The currently implemented patterns are:
...
XHIDDENSTART Click to expand
   ...
   .. image:: https://wiki.analog.com/_media/university/tools/m2k/scopy/pattern_generator_new_6.png
      :align: center
...
.. |image1| image:: https://wiki.analog.com/_media/university/tools/m2k/scopy/pg_2.png
.. |image2| image:: https://wiki.analog.com/_media/university/tools/m2k/scopy/pattern_generator_new_2.png
