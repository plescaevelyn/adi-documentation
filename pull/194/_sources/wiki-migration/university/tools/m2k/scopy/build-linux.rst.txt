...
or if you want to use a custom version of Qt (the one you just installed) -
scopy/CI/appveyor/install_ubuntu_deps.sh <path_to_qt\_> for example:
...
If you are using a custom Qt version set -DCMAKE_PREFIX_PATH to the <Qt
installation folder>/lib/cmake. If you are using the system version don't set
...
Alternatively you can open QtCreator from the Qt folder. Open, configure and
build the project.
