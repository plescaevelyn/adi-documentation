...
-  :doc:`Introduction to the Hardware </wiki-migration/university/tools/m2k/devs/intro>`

   -  :doc:`What's with the name? </wiki-migration/university/tools/m2k/users/name>` *ADALM2000?*
   -  :doc:`Understanding the Internals </wiki-migration/university/tools/m2k/users/reference_manual>`

-  :doc:`Quick Start </wiki-migration/university/tools/m2k/users/quick_start>`
-  Intro to the Software. Installing Device Drivers on:

   -  `Windows <https://wiki.analog.com/../pluto/drivers/windows>`_
   -  `Linux <https://wiki.analog.com/../pluto/drivers/linux>`_
   -  `MAC <https://wiki.analog.com/../pluto/drivers/osx>`_

-  Upgrading the the ADALM2000 `Firmware <https://wiki.analog.com/../m2k/common/firmware>`_.
-  :doc:`Using multiple devices </wiki-migration/university/tools/pluto/users/customizing>`
-  :doc:`Changing the root password on the target </wiki-migration/university/tools/pluto/users/customizing>`
-  :doc:`Enabling persistent SSH keys </wiki-migration/university/tools/pluto/users/customizing>`
-  :doc:`Changing the USB Ethernet Compatibility Mode </wiki-migration/university/tools/pluto/users/customizing>`
-  Once the driver are configured and set up, you can interact with the :adi:`ADALM2000` Active Learning Module from:
...
-  A list of applications and lab activities developed with :adi:`ADALM2000` can found here:
