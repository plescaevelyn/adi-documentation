...
-  Make sure to download, or upgrade your :doc:`Sources </wiki-migration/university/tools/pluto/obtaining_the_sources>`

   -  Make sure you have the recommended/required Vivado versions. It's likely listed in the *archive* section of the Xilinx web site. To check out what you need, look at the following tcl file (which was checked out in the sources link above). ``rgetz@brain:~/github/temp/plutosdr-fw$ grep -i REQUIRED_VIVADO_VERSION $(find ./ -name "adi*.tcl") | grep set
...
| Function                     | File                                                                                                                   |
+==============================+========================================================================================================================+
| PlutoSDR Linux Kernel Config | :git-linux:`arch/arm/configs/zynq_pluto_defconfig`                                                                     |
+------------------------------+------------------------------------------------------------------------------------------------------------------------+
...
| Function                   | File                                                                                                                          |
+============================+===============================================================================================================================+
| PlutoSDR Rev.A Device Tree | :git-linux:`arch/arm/boot/dts/zynq-pluto-sdr.dts`                                                                             |
+----------------------------+-------------------------------------------------------------------------------------------------------------------------------+
| PlutoSDR Rev.B Device Tree | :git-linux:`arch/arm/boot/dts/zynq-pluto-sdr-revb.dts`                                                                        |
+----------------------------+-------------------------------------------------------------------------------------------------------------------------------+
...
| Function                  | File                                                                                       |
+===========================+============================================================================================+
| PlutoSDR Buildroot Config | `zynq_pluto_defconfig <https://github.com/buildroot?pluto/configs/zynq_pluto_defconfig>`_  |
+---------------------------+--------------------------------------------------------------------------------------------+
...
| Function          | File                                                          |
+===================+===============================================================+
| Pluto HDL Project | `Files <https://github.com/hdl?hdl_2016_r2/projects/pluto>`_  |
+-------------------+---------------------------------------------------------------+
...
| Function               | File                                                                                                |
+========================+=====================================================================================================+
| Create FSBL TCL script | `create_fsbl_project.tcl <https://github.com/plutosdr-fw?master/scripts/create_fsbl_project.tcl>`_  |
+------------------------+-----------------------------------------------------------------------------------------------------+
...
| Function                   | File                                                                    |
+============================+=========================================================================+
| PlutoSDR Image Tree Source | `pluto.its <https://github.com/plutosdr-fw?master/scripts/pluto.its>`_  |
+----------------------------+-------------------------------------------------------------------------+
...
| Function                    | File                                                                                          |
+=============================+===============================================================================================+
| PlutoSDR u-boot Config      | `zynq_pluto_defconfig <https://github.com/u-boot-xlnx?pluto/configs/zynq_pluto_defconfig>`_   |
+-----------------------------+-----------------------------------------------------------------------------------------------+
| PlutoSDR u-boot Device Tree | `zynq-pluto-sdr.dts <https://github.com/u-boot-xlnx?pluto/arch/arm/dts/zynq-pluto-sdr.dts>`_  |
+-----------------------------+-----------------------------------------------------------------------------------------------+
