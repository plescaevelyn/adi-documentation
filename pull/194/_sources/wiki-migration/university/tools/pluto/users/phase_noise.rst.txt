...
The `phase noise <https://en.wikipedia.org/wiki/Phase_noise>`_ spectrum of an oscillator shows the noise power in a 1 Hz bandwidth as a function of frequency. Phase noise is defined as the ratio of the noise in a 1 Hz bandwidth at a specified frequency offset, f\ :sub:`m`, to the oscillator signal amplitude at frequency f\ :sub:`o`. It is customary to characterize an oscillator in terms of its single-sideband phase noise, where the phase noise in dBc/Hz is plotted as a function of frequency offset, f\ :sub:`m`, with the frequency axis on a log scale.

Note the curve is approximated by a number of regions, each having a slope of 1/f\ :sup:`X`, where x = 0 corresponds to the "white" phase noise region (slope = 0dB/decade), and x = 1, corresponds to the "flicker" phase noise region (slope = –20 dB/decade). There are also regions where x = 2, 3, 4, and these regions occur progressively closer to the carrier frequency.
...
-  :adi:`Mini-Tutorial 086 : Fundamentals of Phase Locked Loops (PLLs) <media/en/training-seminars/tutorials/MT-086.pdf>`
-  :adi:`Webcast : Explaining Phase Noise <en/education/education-library/webcasts/explaining-phase-noise.html>`
-  :adi:`AN-741 Little Known Characteristics of Phase Noise <media/en/technical-documentation/application-notes/589324855748812403694448557703434217045254275316215330254506699244016AN741_0.pdf>`
...
-  :adi:`Software-Defined Radio for Engineers, Chapter 7, Carrier Synchronization <media/en/training-seminars/design-handbooks/Software-Defined-Radio-for-Engineers-2018/SDR4Engineers_CH07.pdf#page=14>`
-  :adi:`Software-Defined Radio for Engineers, Chapter 6, Timing Synchronization <media/en/training-seminars/design-handbooks/Software-Defined-Radio-for-Engineers-2018/SDR4Engineers_CH06.pdf#page=14>`
