...
This tutorial builds on the concepts covered in: :doc:`Converter Connectivity Tutorial </wiki-migration/university/labs/software/iio_intro_toolbox>` It also serves as a preview to this tutorial that starts to deal with analyzing time series data: :doc:`Precision ADC Tutorial </wiki-migration/university/labs/software/precision_adc_toolbox>`
