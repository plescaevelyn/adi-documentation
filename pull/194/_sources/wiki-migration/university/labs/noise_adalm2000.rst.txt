...
You've seen the memes and T-shirts: "Resistance is Futile", usually showing a resistor sapping power in a circuit, or an attempt to resist, which works fine in simulation but in reality the bypass trace will also have some resistance.
...
Not only is it true that resistance contributes to loss in power delivery circuits, they also contribute noise in sensitive circuits. This is a resistor's "thermal noise", or Johnson noise, and is given by the expression
...
Reality Check: If you're an undergrad EE student, or even a practicing EE in a field a step or two removed from analog electronics, this may seem a bit esoteric. But don't worry - we're going to peel this onion one layer a a time and build some intuition about the nature of noise.
...
- It is based on first principles, so in a sense can act as an uncalibrated standard. - It is truly random, with no repeating patterns.
...
.. |image7| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ad7124_m2k_circuit.png
   :width: 600px
.. |image8| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ad7124_filter_resp_measured_new.png
   :width: 600px
.. |image9| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ad7124_filter_10.png
   :width: 600px
.. |image10| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/simult_50_60_reverse_eng.png
   :width: 600px
.. |image11| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/rev_eng_filters_all_new.png
   :width: 600px
.. |image12| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ad7124_calculated_50_60_fresp_new.png
   :width: 600px
.. |image13| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/generic_buffered_sensor.png
   :width: 600px
.. |image14| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/noise_source_schematic.png
   :width: 600px
.. |image15| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/resistor_based_noise_source_nsd_scopy.png
   :width: 600px
.. |image16| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ltspice_noise_source.png
   :width: 600px
.. |image17| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/inputvoltage_noise_spectrum.png
   :width: 600px
.. |image18| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/lt2057_g10_noise_simulation.png
   :width: 600px
.. |image19| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/m2k_noise_bands_new.png
   :width: 600px
.. |image20| image:: https://wiki.analog.com/_media/university/labs/noise_adalm2000/ad7124_noise_blast_new.png
   :width: 600px
