...
analyse the transient response of the circuit. The pulse-width relative to a
...
2.2 KΩ resistor 1 1 µF capacitor 1 10 KΩ resistor 1 0.01 µF capacitor
...
channel 2 the voltage on the capacitor. Generate a square wave on the channel 1
of the signal generator with 4V amplitude peak-to-peak. The frequency will be
set according to t for the following three cases:

a. Pulse width » 5t : Set the frequency of W1 output such that the capacitor has
   enough time to fully charge and discharge during each cycle of the square
...
Repeat the procedure using R1 = 10 KΩ and C1 = 0.01 µF and record the
measurements.
