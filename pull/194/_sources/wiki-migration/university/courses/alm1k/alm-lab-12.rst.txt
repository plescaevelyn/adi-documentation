...
To investigate the simple differential amplifier using NPN transistors.
...
The use of a simple resistor as the tail current has limitations. You should explore ways to construct a current source to bias the diff pair. These could be made with a couple of additional transistors and resistors as in the stabilized current source from :doc:`Activity 8 </wiki-migration/university/courses/alm1k/alm-lab-8>`.
