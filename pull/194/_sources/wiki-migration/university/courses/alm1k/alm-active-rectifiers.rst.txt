...
Build the circuit in figure 3 and the simple diode based rectifier. Compare the
Vin to Vout voltage drops for all three circuit examples from figures 1 and 3.
