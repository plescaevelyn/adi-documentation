...
Why does the frequency increase as the gate voltage of M\ :sub:`5` increase?

What is the lowest and highest frequency that the circuit will oscillate at?

Try substituting other higher and lower value capacitors for C\ :sub:`1` and again determine the range of frequencies from 0 to 5 V on the gate of M\ :sub:`5`.
