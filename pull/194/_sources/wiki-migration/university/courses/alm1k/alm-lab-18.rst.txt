...
Repeat the sweep of the voltage from channel A AWG and plot the on-resistance of
just the PMOS transistor.
...
Compare the traces you got for just the NMOS, just the PMOS and the combined
NMOS and PMOS cases. Where do they overlap and what does that tell you about the
relative on resistance of the two devices vs the voltage on the switch?
...
multiplexers or the ADG608/609 analog switch (MUX) or ADG333 quad SPDT switch.
