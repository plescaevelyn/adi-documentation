...
-  A `UART <https://wiki.analog.com/resources/fpga/uart_setup>`_ terminal (Tera Term/Hyperterminal), baud rate 115200.
...
-  With every release, we add new features, check the generic build process:
   ...
   -  `GUI <https://wiki.analog.com/resources/fpga/xilinx/software_setup>`_ (manual)
