...
-  `DFP- Device Family Pack for ADuCM4050 <https://wiki.analog.com/resources/eval/user-guides/ev-cog-ad4050lz/software/aducm4x50>`_ - This is a bare minimum pack required to enable working with ADuCM3029 and develop simple applications using the on-chip drivers.
-  `BSP - Board Support Package for EVAL-COG-AD4050LZ <https://wiki.analog.com/resources/eval/user-guides/ev-cog-ad4050lz/software/eval-cog-ad4050lz>`_ - This pack along with the DFP is required to develop applications using the on-board drivers.
