...
.. important::
   ...
   The demo script uses the same polynomial approximation used in `Computing Quinine Concentration <https://wiki.analog.com/resources/eval/user-guides/circuits-from-the-lab/cn0503/fluorescence>`_.
