...
If you have not set up the EV-AD4170-ASD1Z-U1 and controller board previously please go to the :doc:`Quick Start Guide </solutions/reference-designs/ad4170/ad4170>`

If you have not set up/installed the ACE plugin before please go to :doc:`Install Guide </solutions/reference-designs/ad4170/softwareprocedures>`
...
.. image:: ../images/4170_ace_plugin_noise_test.png
   :align: center
   :width: 600
...
-  For more information on the Waveform window go to the software section :doc:`here </solutions/reference-designs/ad4170/softwareprocedures>`
...
-  The value in the Refin1(+/−) field on the Configuration tab is set to 2.5 V
   ...
   -  Information on the reference choice can be viewed in the :doc:`Reference Options Tab </solutions/reference-designs/ad4170/hardwareguide>`
...
:doc:`Return to Software Guide </solutions/reference-designs/ad4170/softwareprocedures>`
