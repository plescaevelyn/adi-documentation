...
It will for sure be :ref:`CE and FCC certified <pluto regulatory_compliance>`
(already passed).
...
.. admonition:: Download
   ...
   - :download:`Rev A Schematics <downloads/plutosdr_schematic_reva.pdf>`
   - :download:`Rev A Gerbers <downloads/plutosdr_gerber_reva.zip>`
   - :download:`Rev A Bill of materials <downloads/plutosdr_bom_reva.xls>`
   - :download:`Rev A Allegro Board File <downloads/plutosdr_brd_reva.zip>`
...
.. admonition:: Download
   ...
   - :download:`Rev B Schematics <downloads/plutosdr_schematic_revb.pdf>`
   - :download:`Rev B Gerbers <downloads/plutosdr_gerber_revb.zip>`
   - :download:`Rev B Bill of materials <downloads/plutosdr_bom_revb.xls>`
   - :download:`Rev B Allegro Board File <downloads/plutosdr_brd_revb.zip>`
     (`compressed <http://www.7-zip.org/7z.html>`__). Get the `Allegro FREE
     Physical Viewer <https://www.cadence.com/en_US/home/tools/pcb-design-and-analysis/allegro-downloads-start.html>`__
     to view.
   - :download:`Rev B Cadence Project <downloads/plutosdr_cadence_project_revb.zip>`
   - :download:`Rev B 3D model (Case, bare PCB, connectors) <downloads/pluto_revb_3d.zip>`
...
:ref:`set config settings <pluto users customizing>`.
...
.. admonition:: Download
   ...
   - :download:`Rev D Schematics <downloads/plutosdr_schematic_revd_0.1.pdf>`
   - :download:`Rev D Gerbers <downloads/plutosdr_gerber_revd.zip>`
   - :download:`Rev D Bill of materials <downloads/plutosdr_bom_revd.xlsx>`
   - :download:`Rev D Allegro Board File <downloads/plutosdr_brd_revd.zip>`
     (`compressed <http://www.7-zip.org/7z.html>`__). Get the `Allegro FREE
     Physical Viewer <https://www.cadence.com/en_US/home/tools/pcb-design-and-analysis/allegro-downloads-start.html>`__
     to view.
   - :download:`Rev D Cadence Project <downloads/plutosdr_cadence_revd.zip>`
     (`compressed <http://www.7-zip.org/7z.html>`__)
   - :download:`Rev B 3D model (Case, bare PCB, connectors) <downloads/pluto_revb_3d.zip>`
     (works for all revisions)
...
-  `Rakon <https://www.rakon.com/>`__ :download:`1.8V RXO3225M 40MHz <downloads/rakon_rxo3225m_40mhz_513371_1.8v.pdf>`
