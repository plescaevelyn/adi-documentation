.. imported from: https://wiki.analog.com/resources/eval/user-guides/ad7192/softwareguide

.. _ad7192 softwareguide:
...
Download the ACE software from the ACE software page or the AD7192 product page.
Install ACE on a PC **before using** the EVAL-AD7192ASDZ.
...
#. Hit the + button next to the Zipped Plug-in Sources.
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7192/ad7192aceplugin.png
      :width: 400px
...
#. If the EVAL-AD7192ASDZ is not connected to the USB port via the controller
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7190/ad7192_attachhardware.png
      :width: 400px

#. Double click the AD7192 Eval Board icon to open the AD7192 Eval Board view
   window shown below:

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7190/ad7192_board_view.png
      :width: 400px
...
#. Click Software Defaults and then click Apply Changes to apply the default
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7192/ad7192chipview.png
      :width: 600px
...
:dokuwiki:`Software Installation Procedures </resources/eval/user-guides/AD7192/softwareguide#ace_plugin_install_guide>`
section and the
:dokuwiki:`Evaluation Board Set-up Procedures </resources/eval/user-guides/AD7192/hardwareguide#set-up_procedures>`
...
:dokuwiki:`Visit the demo mode section here </resources/eval/user-guides/ad7192/softwareguide/demo_modes>`
...
#. :dokuwiki:`Weigh scale Demo </resources/eval/user-guides/ad7192/softwareguide/demo_modes#weigh_scale_demo_test>`
...
#. Navigate to the Virtual Eval tool by clicking this link:
   ...
   alternatively, by going to the AD7192 homepage on analog.com and finding the
   link there.
...
:dokuwiki:`Previous Page: Hardware Guide </resources/eval/user-guides/ad7192/hardwareguide>`
