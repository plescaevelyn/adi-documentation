.. imported from: https://wiki.analog.com/resources/eval/user-guides/ad7194/hardwareguide

.. _ad7194 hardwareguide:
...
:dokuwiki:`Software Procedures </resources/eval/user-guides/ad7194/softwareguide>`
...
- Warning: The evaluation software and drivers must be installed before
  connecting the EVAL-AD7194ASDZ evaluation board and EVAL-SDP-CB1Z board to the
...
.. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7194/ad7194_block_diag.png
   :width: 600px
...
.. list-table::
   ...
   * - Connection
     - Function
   * - 1
     - AIN 13 without DC filtering
   * - 2
     - AIN 14 without DC filtering
   * - 3
     - External Reference +
   * - 4
     - External Reference -
   * - 5
     - AIN 15 with DC filtering
   * - 6
     - AIN 16 with DC filtering
   * - 7
     - Excitation+
   * - 8
     - Ground/Sheild
...
:download:`https://wiki.analog.com/_media/resources/eval/user-guides/ad7194/02-072728-01-a.pdf`

Bill of Materials
-----------------

:download:`https://wiki.analog.com/_media/resources/eval/user-guides/ad7194/ad7194_bom.pdf`

:dokuwiki:`Next Page: Software Procedures </resources/eval/user-guides/ad7194/softwareguide>`

:dokuwiki:`Return to Homepage </resources/eval/user-guides/ad7194>`
