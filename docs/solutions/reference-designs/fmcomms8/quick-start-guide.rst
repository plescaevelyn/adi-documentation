...
-  SD Card 16GB imaged using the instructions here: `Zynq & Altera SoC Quick Start Guide <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_
...
-  `iio_attr <https://wiki.analog.com/resources/tools-software/linux-software/libiio/iio_attr>`_
...
Using the `JESD204 (FSM) Interface Linux Kernel Framework <https://wiki.analog.com/resources/tools-software/linux-drivers/jesd204/jesd204-fsm-framework>`_ the tranceivers should always be in a synchronized state.

Check JESD204B Link Status
^^^^^^^^^^^^^^^^^^^^^^^^^^

Using the `JESD204B Status Utility <https://wiki.analog.com/resources/tools-software/linux-software/jesd_status>`_
