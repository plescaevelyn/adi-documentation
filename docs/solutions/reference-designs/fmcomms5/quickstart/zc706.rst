...
#. Write the :external+kuiper:doc:`Kuiper Linux <index>` image to the
   ...
   ``devicetree.dtb``) for the ZC706 + FMCOMMS5 combination to the
   BOOT partition
#. Connect the :adi:`AD-FMCOMMS5-EBZ <AD-FMCOMMS5-EBZ>` to the ZC706
   dual FMC connectors
#. Insert the SD card into connector J30
...
#. Set boot mode switch SW11: 1-Down, 2-Down, 3-Up, 4-Up, 5-Down
   ...
   .. image:: ../images/zc706_bootmode.jpg
      :width: 400
...
.. collapsible:: Complete boot log
   ...
   ::
      ...
      reading uImage
      9145624 bytes read in 525 ms (16.6 MiB/s)
      reading devicetree.dtb
      27631 bytes read in 27 ms (999 KiB/s)
      ** Unable to read file uramdisk.image.gz **
      ...
      ## Flattened Device Tree blob at 02a00000
         ...
         Loading Device Tree to 1fff6000, end 1ffffbee ... OK
      ...
      adv7511 2-0039: probe with driver adv7511 failed with error -5
      ...
      rtc-pcf8563 5-0051: setting system clock to 2026-04-24T11:07:43 UTC (1777028863)
      ...
      axi_sysid 45000000.axi-sysid-0: [fmcomms5] on [zc706] git branch <hdl_2026_r1> git <5da8736cb717e92a827934dd1c272b5c07c8e871> clean [2026-03-20 19:56:25] UTC
      ...
      systemd-journald[88]: Collecting audit messages is disabled.
