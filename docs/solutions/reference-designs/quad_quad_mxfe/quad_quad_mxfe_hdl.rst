...
This reference design is not tested in hardware but in testbench, it should serve as a reference for building systems with multiple channels e.g 128 ADC channels and 128 DAC channels or more realized with :adi:`AD9081` parts.
...
Built on top of `VCU128 <https://www.xilinx.com/VCU128>`_ but does not match any FMC connector due the high number of lanes. The design requires 64 lanes for Rx and 64 lanes for Tx, but the FMC+ connector can expose only 24 pairs instead of 64.
...
-  `AD9081 MxFE Linux Driver <https://wiki.analog.com/resources/tools-software/linux-drivers/iio-mxfe/ad9081>`_
...
.. image:: images/quad_quad_mxfe.png
   :align: center
...
.. image:: images/quad_jesd_core.png
   :align: center
