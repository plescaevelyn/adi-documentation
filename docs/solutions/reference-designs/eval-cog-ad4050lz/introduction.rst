...
-  An MCU *Cog* (such as the :doc:`EV-COG-AD4050LZ </solutions/reference-designs/eval-cog-ad4050lz/cog_hw_userguide>`) which has an on-board debugger and test-points for monitoring energy consumption.
-  An optional connectivity *Cog* (such as the `EV-COG-BLEINTP1Z Connectivity Cog <https://wiki.analog.com/resources/eval/user-guides/ev-cog-bleintp1z>`_) which offers BTLE, LPWAN or WiFi connectivity options.
