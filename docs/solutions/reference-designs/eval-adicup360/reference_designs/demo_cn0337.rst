...
This project is a good example for how to use :doc:`EVAL-ADICUP360 board </solutions/reference-designs/eval-adicup360/hardware/base_board>` in different combinations with pmod boards. It expand the list of possible applications that can be done with the base board.
...
.. image:: ../images/cn0337_demo_1.png
   :align: left
   :width: 550
...
.. note::
   ...
   Please visit `CN0337 Software User Guide page <https://wiki.analog.com/resources/eval/user-guides/circuits-from-the-lab/cn0337>`_ to find out how to get and how to use the CN0337 evaluation software.

.. image:: ../images/cn0337_demo_2.png
   :align: right
   :width: 550
...
.. image:: ../images/cn0337_demo_3.png
   :align: center
   :width: 500
...
.. admonition:: Download
   ...
   -  `ADuCM360_demo_cn0337.Bin <https://github.com/analogdevicesinc/EVAL-ADICUP360/releases/download/Release-1.0/ADuCM360_demo_cn0337.bin>`_
...
.. image:: ../images/cn0337_demo_5.png
   :align: left
   :width: 340
