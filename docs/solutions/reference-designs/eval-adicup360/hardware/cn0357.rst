...
This set of jumpers allows for changing the pin mapping of the AD7790 and
AD5270 chip select lines to different Arduino digital pins. Place jumper/shunt
as shown to connect to the corresponding Digital IO pin.

**AD7790 CS Selection**

.. image:: ../images/cn0357-hdr-01.png
   :align: left
   :width: 101
...
.. image:: ../images/cn0357-hdr-02.png
   :align: left
   :width: 100
...
-  :doc:`ADICUP360 + CN0357 Demo </solutions/reference-designs/eval-adicup360/reference_designs/demo_cn0357>`
-  `ADICUP3029 + CN0357 Bluetooth Demo <https://wiki.analog.com/resources/eval/user-guides/eval-adicup3029/reference_designs/demo_cn0357>`_
-  `Arduino Uno + CN0357 Demo <https://wiki.analog.com/resources/eval/user-guides/arduino-uno/reference_designs/demo_cn0357>`_
...
.. admonition:: Download
   ...
   -  `Schematic <../resources/eval-cn0357-ardz-cadenceschematic-revc.pdf>`_
   -  `Layout <../resources/eval-cn0357-ardz-cadencelayout-revc.pdf>`_
   -  `Bill of Materials <../resources/eval-cn0357-ardz-bom-revc.pdf>`_
   -  `Cadence Files <../resources/eval-cn0357-ardz-cadencelibrary-revc.zip>`_
   -  `Gerber Files <../resources/eval-cn0357-ardz-gbr-revc.zip>`_
   
   EVAL-CN0357-ARDZ Rev B Files
   
   -  `Schematic <../resources/eval-cn0357-ardz-cadenceschematic-revb.pdf>`_
   -  `Layout <../resources/eval-cn0357-ardz-cadencelayout-revb.pdf>`_
   -  `Bill of Materials <../resources/eval-cn0357-ardz-bom-revb.pdf>`_
   -  `Cadence Files <../resources/eval-cn0357-ardz-cadencelibrary-revb.zip>`_
   -  `Gerber Files <../resources/eval-cn0357-ardz-gbr-revb.zip>`_
