...
The following wiki page goal is to help new users and ADXL362 users to have an
easy start testing and prototyping the ADXL367.

-  `ADXL367 Quick Start User Guide wiki <https://wiki.analog.com/resources/quick-start/adxl367_quick_start_guide>`_
...
.. |image2| image:: ../images/eval-adxl367-sdp_photo.jpg
