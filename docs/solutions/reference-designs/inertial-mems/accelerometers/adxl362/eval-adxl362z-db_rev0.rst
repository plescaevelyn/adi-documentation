...
.. important::
   ...
   | If your board is labeled REV 2 (on the back), please visit :doc:`this page </solutions/reference-designs/inertial-mems/accelerometers/adxl362/eval-adxl362z-db>` instead.
...
Full functionality of the board is availabe using USB power.

Design and Integration Files
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

+-------------+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
| Schematics: | `PDF <../../resources/eval-adxl362z-db_schematic.pdf>`_ |                                                                                                                                      |
+=============+=========================================================+======================================================================================================================================+
| Layouts:    | `PDF <../../resources/eval-adxl362z-db_layout.pdf>`_    | `CAM <../../resources/eval-adxl362z-db_layout.zip>`_                                                                                 |
+-------------+---------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
...
-  **Datalogger and GUI (includes real-time data viewer and tilt sensor)**: logs data onto (supplied) microSD card. `ZIP <../../resources/adxl362db_datalogger_and_gui.zip>`_ *(includes .hex firmware and .exe GUI)*
...
-  Set jumpers: J6, J7, J8, and J9 (between the USB connector and the switch) to
   the 1-2 position. Set jumper J2 (near the display connector) to the 2-3
   position for USB power.
...
-  Click “Start”.
-  When flashing is complete, disconnect the USB cable (to power the board off)
   and set jumpers J6 - J9 back to the 2-3 position. Leave J2 where it is to USB
   power, or move it to the 1-2 position to power the board from the coin cell.
...
.. |image1| image:: ../../images/board_front_jumpers_labeled.png
   :width: 400

.. |image2| image:: ../../images/board_front_jumpers_labeled.png
   :width: 400
