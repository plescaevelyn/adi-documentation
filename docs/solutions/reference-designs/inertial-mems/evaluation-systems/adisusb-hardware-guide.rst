...
+======================================================+======================================================================================================================+
| :adi:`ADIS16003CCCZ <ADIS16003>`                     | `003es.zip <../resources/003es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16006CCCZ <ADIS16006>`                     | `003es.zip <../resources/003es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16060CCCZ <ADIS16060>`                     | `003es.zip <../resources/003es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16201CCCZ <ADIS16201>`                     | `201es.zip <../resources/201es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16203CCCZ <ADIS16203>`                     | `203es.zip <../resources/203es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16209CCCZ <ADIS16209>`                     | `209es.zip <../resources/209es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16260BCCZ <ADIS16260>`                     | `265es.zip <../resources/265es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
| :adi:`ADIS16265BCCZ <ADIS16265>`                     | `265es.zip <../resources/265es.zip>`_                                                                                |
+------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------+
...
Click the software download link for your target device and save the archive
somewhere convenient (like your desktop). Once extracted, the download file will
contain three separate files: The CAB file (ADIS16135_Rev_4.cab), the setup file
(setup.exe), and the setup list.
...
.. tip::
   ...
   The instructions shown below reference the ADIS1613x software, so your
   software may appear a bit different.

Main Window
~~~~~~~~~~~

Once the Evaluation Software starts-up, the Main Window will appear and look
like the following picture. The second picture provides color-coded boxes to
support further discussion of each function in this screen.
...
.. |image1| image:: ../images/13x-zipfile-download.png
   :width: 600

.. |image2| image:: ../images/adisusb-driver-foundnewhardware.png
   :width: 400

.. |image3| image:: ../images/adisusb-driver-hardware-install.png
   :width: 400

.. |image4| image:: ../images/adisusb-driver-hardware-wizard.png
   :width: 400

.. |image5| image:: ../images/adisusb-driver-complete-wizard.png
   :width: 400

.. |image6| image:: ../images/13x-adisusb-main_screen.png
   :width: 800

.. |image7| image:: ../images/13x-adisusb-main_screen-defined.png
   :width: 800

.. |image8| image:: ../images/13x-adisusb-datalog.png
   :width: 400

.. |image9| image:: ../images/13x-adisusb-datalog-defined.png
   :width: 400
