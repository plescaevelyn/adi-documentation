...
After alignment, press the unit down on the board, as shown in the following
picture.

.. image:: ../images/adis16130-insertion-02.jpg
   :width: 300
...
.. image:: ../images/adis16130-screws.jpg
   :width: 300

Step #3
~~~~~~~

Install the interface cable onto J2 of the interface board. In this particular
example, ink was added to the location on the cable connector to identify pin
#1.
...
.. image:: ../images/eval-adis-jp1-ext.jpg
   :width: 300

Step #2
~~~~~~~

Hook an external power supply up to J3. Set the supply for +5V (verify with a
meter at J3).

.. image:: ../images/eval-adis-j3.png
   :width: 500
...
`adis16130-eval-adis-datacaptureapp.zip <../resources/adis16130-eval-adis-datacaptureapp.zip>`_

SOFTWARE GUIDE
==============

The ADIS16130 software package does not require installation. Double-click on
the \*.exe file to launch this package and get started.
...
.. image:: ../images/adis16130-es-main-01.png
   :width: 800
...
.. image:: ../images/adis16130-es-main-02.png
   :width: 800

The red **False** indicator will change to a green **True** indication when this process completes and is successful.

.. image:: ../images/adis16130-es-main-03.png
   :width: 800

Main Menu/Plot Scaling
----------------------

Move the mouse pointer over the waveform recorder screen and right-click to
access to window scaling functions.

.. image:: ../images/adis16130-es-main-04.png
   :width: 800

Note the changes to the the gyro scaling after completing these adjustments:

.. image:: ../images/adis16130-es-main-05.png
   :width: 800
...
.. image:: ../images/adis16130-es-main-06.png
   :width: 800

.. image:: ../images/adis16130-es-main-07.png
   :width: 800
...
.. image:: ../images/adis16130-es-main-08.png
   :width: 800
...
.. image:: ../images/adis16130-es-datafile-01.png
   :width: 800
...
.. image:: ../images/adis16130-es-main-09.png
   :width: 800

The following relationships help determine the two key input variables for the
Streaming Mode.

.. image:: ../images/adis16130-es-mm-ds-01.png
   :width: 400

The total samples and averaging factors are both inputs that the ADIS16130
software package provides:

.. image:: ../images/adis16130-es-main-10.png
   :width: 800

Here is an example that supports producing a 1 hour time record, which has a
data sample rate of 100 samples per second.

.. image:: ../images/adis16130-es-mm-ds-02.png
   :width: 300
...
.. image:: ../images/adis16130-es-mm-noise-01.png
   :width: 800
...
.. image:: ../images/adis16130-es-mm-noise-02.png
   :width: 600

The data streaming progress shows up as a "Stream xx% complete," with 100%
complete indicating that all of the data samples are in the target file.

.. image:: ../images/adis16130-es-mm-noise-03.png
   :width: 800
...
`adis16130-noisetest-01.xlsx <../images/adis16130-noisetest-01.xlsx>`_

EXAMPLE #2: Sensitivity
-----------------------

This example exercise is based on the calibration method that the following
article reference explains:
...
Start this process by entering 114000 samples for the record size, which
provides a data record of 20 seconds at the nominal sample rate of 5700SPS.

.. image:: ../images/adis16130-es-mm-sens-02.png
   :width: 800
...
NOTE: Over-ranging the gyroscope will introduce errors. This might require
iteration to achieve expected results.
...
.. image:: ../images/adis16130-es-mm-sens-03.png
   :width: 600

Here is the spreadsheet file which contains the data and analysis, which
produced the rate and angle graphs:

`adis16130-senstest-01.xlsx <../images/adis16130-senstest-01.xlsx>`_
...
The following table illustrates the thermal profile for the temperature chamber
for this experiment. For those who are developing calibration systems, the dwell
times and ramp rates are likely to be an area for application-specific
optimization.

================================================================= =============================== =======================
Temperature                                  Dwell Time/Ramp Rate
Time
================================================================= =============================== =======================
+25C                                                              5 min                           5 min
...
-40C                                                              30min                           30
min
-40C to +85C                                 ~2 degC/min
62.5 min (67.5 min max)
+85C                                                              15 min                          15 min
...
capture process up to collect data for 210 minutes. This allows for 15 extra
minutes, for any expected delays or handling. Of course, this is adjustable,
once someone has enough experience to understand how these adjustments impact
the overall characterization goals. For now, calculate the total samples by
multiplying the record time and the sample rate together.

Total samples = 5700 SPS x 210 min x 60 sec/min = 71820000 samples

In order to keep the file size under control, set the averages to produce a
sample rate of 5 SPS in the data record.

Averages = Sample rate/Record data rate = 5700 SPS/5 SPS = 1140

.. image:: ../images/adis16130-es-mm-sens-05.png
   :width: 800

The following figure provides the results of this process.

.. image:: ../images/adis16130-es-mm-sens-04.png
   :width: 600
...
Click on the following file name to download the MS Excel file for this test
run.

`adis16130-biastemp-1.xlsx <../images/adis16130-biastemp-1.xlsx>`_

SUPPORTING DETAILS (UNDER CONSTRUCTION)
=======================================

The purpose of this section is to provide supporting documentation, which might
be useful for longer-term review of these techniques.
...
Click on the following link to access the electrical schematic for this
interface PCB:

`gs09654rasch.pdf <../resources/gs09654rasch.pdf>`_

Click on the following document link to access the printed circuit board layout
for this interface PCB:

`gs09655rapcb.pdf <../resources/gs09655rapcb.pdf>`_
...
.. |image1| image:: ../images/adis16130-eval-adis-f01.jpg
   :width: 250

.. |image2| image:: ../images/adis16130-eval-adis-f03.jpg
   :width: 250

.. |image3| image:: ../images/adis16130-eval-adis-f02.jpg
   :width: 250

.. |image4| image:: ../images/adis16130-insertion-01.jpg
   :width: 300

.. |image5| image:: ../images/adis16130-insertion-01b.jpg
   :width: 300

.. |image6| image:: ../images/adis16130-cable-insertion-01.jpg
   :width: 300

.. |image7| image:: ../images/adis16130-cable-insertion-02.jpg
   :width: 300

.. |image8| image:: ../images/eval-adis-j1-insertion-01.jpg
   :width: 300

.. |image9| image:: ../images/eval-adis-j1-insertion-02.jpg
   :width: 300

.. |image10| image:: ../images/eval-adis-j1-insertion-03.jpg
   :width: 300

.. |image11| image:: ../images/eval-adis-usbdriverinstall-01.png
   :width: 400

.. |image12| image:: ../images/eval-adis-usbdriverinstall-02.png
   :width: 400

.. |image13| image:: ../images/eval-adis-usbdriverinstall-03.png
   :width: 400

.. |image14| image:: ../images/eval-adis-usbdriverinstall-04.png
   :width: 400

.. |image15| image:: ../images/adis16130-eval-adis-inoven2.jpg
   :width: 400

.. |image16| image:: ../images/adis16130-eval-adis-outofoven1.jpg
   :width: 400
