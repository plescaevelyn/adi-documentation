...
.. image:: ../images/40x-spi-connection.png
   :width: 400
...
.. image:: ../images/36x-adisusb-mnt-locations.png
   :width: 800
...
.. image:: ../images/36x-adisusb-mounted.png
   :width: 800
...
.. image:: ../images/40x-adisusb-main-screen-voltage-error.png
   :width: 800
...
.. image:: ../images/40x-zipfile-download.png
   :width: 800
...
.. image:: ../images/40x-adisusb-registers.png
   :width: 600

The color coded boxes illustrate the different functions that this window
provides.

.. image:: ../images/40x-adisusb-registers-defined.png
   :width: 600
...
This section currently has no :adi:`ADIS16400`-specific content, but the :doc:`ADIS16448 Evaluation on the EVAL-ADIS Wiki Site </solutions/reference-designs/inertial-mems/imu/adis16448>` has some good examples to start with.
...
.. |image5| image:: ../images/40x-prgrm-group.png
   :width: 400

.. |image6| image:: ../images/40x-finished.png
   :width: 400
...
.. |image11| image:: ../images/40x-adisusb-main-screen.png
   :width: 800

.. |image12| image:: ../images/40x-adisusb-main-screen-defined.png
   :width: 800

.. |image13| image:: ../images/imu_6dof-334-datalog.png
   :width: 400

.. |image14| image:: ../images/imu_6dof-334-datalog-defined.png
   :width: 400

.. |image15| image:: ../images/40x-adisusb-datalog.png
   :width: 400

.. |image16| image:: ../images/40x-adisusb-datalog-defined.png
   :width: 400
