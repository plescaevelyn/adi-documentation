...
.. image:: ../images/36x-adisusb-main-screen-voltage-error.png
   :width: 800
...
This section currently has no :adi:`ADIS16364`-specific content, but the :doc:`ADIS16448 Evaluation on the EVAL-ADIS Wiki Site </solutions/reference-designs/inertial-mems/imu/adis16448>` has some good examples to start with.
...
.. |image5| image:: ../images/imu_6dof-v2programgroup.png
   :width: 400

.. |image6| image:: ../images/imu_6dof-v2completed-install.png
   :width: 400
...
.. |image11| image:: ../images/36x-adisusb-main-screen.png
   :width: 800

.. |image12| image:: ../images/36x-adisusb-main-screen-defined.png
   :width: 800
