...
.. image:: ../images/229demo-completesystem01.png
   :width: 400
...
shown in this picture is manufactured by Saft (P/N: LS14250) and is available
through many different online sources. Just Google-search "Saft LS-14250" to
produce a list of sellers. The other parts for the battery assembly are: The
battery holder 1/2AA cell Memory Protection Devices (P/N: BH1/2AA-3), Connector
housing TE Connectivity (P/N: 1375820-2) and Connector Pins TE Connectivity
(P/N: 1445336-3). The wire should be 22 AWG to 28 AWG and soldered to the
battery holder posts.

.. image:: ../images/battery-assembly.png
   :width: 400
...
The following picture identifies all of the key components of this demonstration
system.

.. image:: ../images/229_vibedemo_229-kitcontents04.png
   :width: 600
...
.. image:: ../images/229_vibedemo_000-antenna04.png
   :width: 800
...
.. image:: ../images/229_vibedemo_229-antenna05.png
   :width: 800

Step #4: Install ADIS16229AMLZ
------------------------------

Find the two holes on the side of the plate, located next to the black plastic
motor case. Use (2) M2x0.4x12 machines screws (at least 8mm long) to secure this
assembly to the plate. NOTE: The threads can strip, only tighten to
"finger-snug."

.. image:: ../images/229_vibedemo_229-install01.png
   :width: 800

Step #5: Install Battery
------------------------

Install the battery, with the positive terminal on the side that has the red
wire, as shown in the following pictures:

.. image:: ../images/229_vibedemo_229-battery03.png
   :width: 800
...
.. image:: ../images/229_vibedemo_000-eval-adis01.png
   :width: 800

Step #7: Connect Motor
----------------------

Before connecting the motor to the PC, turn the potentiometer all of the way,
counter-clockwise, to set the vibration to its lowest possible setting. Then,
connect the motor to a PC, using one of the Mini USB cables for power. After
connecting this to the PC, turn the potentiometer in the clockwise direction,
until the vibration level is sufficient for the demonstration.

.. image:: ../images/229_vibedemo_229-vibemotor.png
   :width: 800
...
.. image:: ../images/229_vibedemo_229-battery04.png
   :width: 800
...
This section will offer software tips for using this demonstration system. For a complete guide to the Vibration Evaluation Program, click on the following link: :doc:`Vibration Evaluation Program Wiki Guide </solutions/reference-designs/inertial-mems/imu/vibrationevaluationprogram>`
...
.. image:: ../images/229_vibedemo_vep-01.png
   :width: 400

.. image:: ../images/229_vibedemo_vep-02.png
   :width: 400

This will be followed by an attempt to connect with the sensor, which will take
approximately 5 seconds, then a "success" message, if the connection was
completed and verified:

.. image:: ../images/229_vibedemo_vep-04.png
   :width: 400

Click on **OK** and the **Main Menu** will appear.

.. image:: ../images/229_vibedemo_vep-mainmenu01.png
   :width: 800
...
.. container:: center round box
   ...
   **Typical Error Messages and Solutions:**
   ...
   .. image:: ../images/16629_unsuccessful_addition.jpg
      :align: center
      :width: 300
...
.. image:: ../images/229_add_sensor.jpg
   :align: center
   :width: 700
...
.. image:: ../images/229_vibedemo_vep-06.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-07.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-06a.png
   :width: 800

After starting this mode, start turning the potentiometer on the motor, until it
starts to respond. After it starts vibrating, turn it down as low as possible,
without completing stopping the vibration. When the motor is on, it typically
generates enough sound to hear.

.. image:: ../images/229_vibedemo_vep-08.png
   :width: 800

While tweaking the motor up, notice the change in the FFT result, on the y-axis
in particular.

.. image:: ../images/229_vibedemo_vep-09.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-10.png
   :width: 800

Click on the **>** button in this window to increase the range on the scale.

.. image:: ../images/229_vibedemo_vep-11.png
   :width: 800

Click on **Close** to close the scale adjustment box.

If the motor vibration is high enough, the plate could start moving around on
its surface. Notice the change in the FFT profile: the magnitude increases, but
at the lower frequencies.

.. image:: ../images/229_vibedemo_vep-12.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-14.png
   :width: 800
...
Let's start with a simple example, where we will set a single alarm band to
monitor in this demo system. The following figure establishes the start
frequency, stop frequency on one of the levels (Alarm 1), which serves as the
"warning" level.

.. image:: ../images/229_vibedemo_vep-alarmdemo-01.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-02.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-03.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-04.png
   :width: 800

Enter "2" into the **User Entry Box**, as shown below.

.. image:: ../images/229_vibedemo_vep-alarmdemo-05.png
   :width: 800

Click on **Write** as shown in the graphic below.

.. image:: ../images/229_vibedemo_vep-alarmdemo-06.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-07.png
   :width: 800

Select this register with the mouse and then enter **2** into the **User Entry** box.

.. image:: ../images/229_vibedemo_vep-alarmdemo-08.png
   :width: 800

Click on **Write**, as shown in the graphic below.

.. image:: ../images/229_vibedemo_vep-alarmdemo-09.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-11.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-12.png
   :width: 800

Experiment with increasing the vibration and try again.

.. image:: ../images/229_vibedemo_vep-alarmdemo-13.png
   :width: 800
...
.. image:: ../images/229_vibedemo_vep-alarmdemo-10.png
   :width: 800

Additional Resources
--------------------

:doc:`ADIS16000/ADIS16229/EVAL-ADIS Wiki Guide </solutions/reference-designs/inertial-mems/imu/adis16000-adis16229-eval-adis>`
