...
The ADIS16IMU1/PCBZ provides a simple method for connecting an existing processor system to the :adi:`ADIS16375BMLZ <ADIS16375>`. Click on one of the following link for more information on this breakout boards.

:doc:`ADIS16IMU1/PCB Wiki Guide </solutions/reference-designs/inertial-mems/imu/adis16imu1-pcb>`

NOTE: :adi:`ADIS16375BMLZ <ADIS16375>` units are sold separately.

NOTE: Order (1) :adi:`ADIS16375BMLZ <en/mems-sensors/mems-inertial-measurement-units/adis16375/products/product.html#product-samples>` and (1) :adi:`ADIS16IMU1/PCBZ <en/mems-sensors/mems-inertial-measurement-units/adis16375/products/product.html#product-samples>` to acquire the same materials that used to come in the ADIS16375/PCBZ, which is no longer available.

EVAL-ADIS: PC EVALUATION
------------------------

For those who would prefer to perform PC-based evaluation of the :adi:`ADIS16375BMLZ <ADIS16375>`, before developing their own embedded system, the :adi:`EVAL-ADIS` is the appropriate system to use. The remainder of this Wiki site will focus on PC-based evaluation with the :adi:`EVAL-ADIS` system. Here is a list of equipment required for this:

:adi:`EVAL-ADISZ <EVAL-ADIS>`

:adi:`ADIS16375BMLZ <ADIS16375>`
...
Place the ADIS16375 device over the "F" mounting holes and align its connector with J4 on the :adi:`EVAL-ADIS`.
...
be an indicator of connector misalignment. The suggested torque setting for the
...
Set the jumper JP1 on the (:adi:`EVAL-ADIS`) to the **+3.3V** position setting for the :adi:`ADIS16375AMLZ <ADIS16375>`. The following picture shows JP1 in the **+3.3V** position

.. image:: ../images/375-eval-adis-3.3v.png
   :width: 500
...
.. |image3| image:: ../images/adis16480-eval-adis-holelocations.png
   :width: 500

.. |image4| image:: ../images/375-correct-j4-connection.png
   :width: 500

.. |image5| image:: ../images/adis1648x_evaladis_install_step01-02.jpg
   :width: 400

.. |image6| image:: ../images/adis1648x_evaladis_install_step01-02b.jpg
   :width: 400
