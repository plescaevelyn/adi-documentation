...
The :adi:`AD7175-8 <en/products/ad7175-8.html>` has a maximum
channel-to-channel scan rate of 50 kSPS (20 µs) for fully settled data
The output data rates range from 5 SPS to 250 kSPS. The device includes
...
The :adi:`AD7175-8 <en/products/ad7175-8.html>` evaluation software is set up
...
:doc:`Continue to Software Guide </solutions/reference-designs/eval-ad7175-8ardz/software>`
