...
#. Connect the **ADRV9009-ZU11EG** System on Module to the **ADRV2CRR-FMC**
   carrier board.
      ...
      .. image:: ../images/adrv9009-zu11eg-test-setup.jpg
         :width: 500
...
.. shell::
   ...
   root@analog:~# iio_info | grep iio:device
      ...
      iio:device7: axi-adrv9009-rx-obs-hpc (buffer capable)
      iio:device8: axi-adrv9009-tx-hpc (buffer capable)
...
.. shell::
   ...
   IIO context has 15 devices:
         ...
         hwmon2, adm1177: found 2 channels
         hwmon3, adm1266: found 17 channels
         hwmon4, axi_fan_control: found 3 channels
...
The data capture window should look like in the following figure.

.. image:: ../images/adrv9009-zu11eg-iio-capture.png
   :width: 500
