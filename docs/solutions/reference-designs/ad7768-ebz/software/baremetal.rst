...
-  Clone the HDL GitHub repository (see `git <https://wiki.analog.com/resources/fpga/docs/git>`_)
...
.. image:: ../images/ad7768evb_fmc_hdl.svg
...
.. admonition:: Download
   ...
   -  no-OS IIO - `iio <https://wiki.analog.com/resources/tools-software/no-os-software/iio>`_
