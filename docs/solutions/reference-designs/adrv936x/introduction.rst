...
|                                                                 |               | Tx / Rx      | (Ranges)            | (Ranges)            |                                                          |                   |
+=================================================================+===============+==============+=====================+=====================+==========================================================+===================+
| `ADALM-PLUTO <https://wiki.analog.com/university/tools/pluto>`_     | 1 x AD9363    | 1 x 1        | 1 (325 - 3800 MHz)  | 1 (325 - 3800 MHz)  | Active Learning Module                                   | Stand Alone (USB) |
+-----------------------------------------------------------------+---------------+--------------+---------------------+---------------------+----------------------------------------------------------+-------------------+
...
-  `Quickstart <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/quickstart>`_
...
-  `Introduction <https://wiki.analog.com/resources/eval/user-guides/ad9361>`_ to the AD9361/AD9364
-  `Tuning <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/filters>`_ the AD9361/AD9364 FIR Filters for your application
-  How to `simulate <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/simrf>`_ the part with `MathWorks SimRF <https://www.mathworks.com/hardware-support/analog-devices-rf-transceivers.html>`_, to see if it is appropriate for your application
...
-  How the `Linux <https://wiki.analog.com/resources/tools-software/linux-drivers/iio-transceiver/ad9361>`_ or `no-OS <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/no-os-functions>`_ driver works, or can be integrated into your system
...
-  Modifying the `reference_hdl ADI provided HDL <https://wiki.analog.com/resources/fpga/docs/tips>`_
-  Tuning other paramters, like `ACG for your application/waveform <https://wiki.analog.com/resources/eval/user-guides/ad9361_agc_tuning>`_
