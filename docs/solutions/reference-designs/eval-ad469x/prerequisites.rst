...
#. The AD469X-based evaluation boards:
   :adi:`EVAL-AD4696FMCZ` and :adi:`EVAL-AD4692-ARDZ`
#. An FPGA carrier platform. Our recommended one can be found
   :ref:`here <eval-ad469x-carriers>`.
...
#. An SD card with at least 16 GB of memory (in case you're using Linux). You
