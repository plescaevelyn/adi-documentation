...
.. _fmcomms6 user-guide:

AD-FMCOMMS6-EBZ User Guide
==========================

The :adi:`EVAL-AD-FMCOMMS6-EBZ` eval board is a 400MHz to 4.4GHz receiver based
on the :adi:`AD9652` dual 16bit analog to digital converter, the :adi:`ADL5566`
High Dynamic Range RF/IF Dual Differential Amplifier and the :adi:`ADL5380`
...
.. image:: images/top_view_main_page.png
   :align: right
   :width: 400
...
-  :adi:`ADP2370` high efficiency, low quiescent current, 800 mA buck
   (step-down) dc-to-dc converters in small 8-lead, 3 mm × 3 mm LFCSP (QFN)
   packages.
...
-  :adi:`ADF4351` allows implementation of fractional-N or integer-N
   phase-locked loop (PLL) frequency synthesizers if used with an external loop
   filter and external reference frequency.
...
-  :ref:`Hardware <fmcomms6 hardware>` (including schematics)
