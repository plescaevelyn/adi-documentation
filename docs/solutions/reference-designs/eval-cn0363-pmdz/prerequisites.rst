...
The :adi:`CN0363` HDL reference design and software are designed to operate with the following hardware and FPGA development system:
...
The equipment should be connected as shown below, make sure that all power is off before starting to make the connections.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/eval-cn0363-pmdz/cn0363_setup.png
   :align: right
   :width: 500px

-  PMOD JA connector of the ZED board connected to the PMOD connector on the EVAL-CN0363-PMDZ
-  USB mouse and keyboard connected to the ZED board (J13)
-  12 V power supply connected to the ZED board (J20)
-  3.3V VADJ
-  Ethernet cable with internet connection connected to the ZED board (only required for software updates)
...
.. image:: https://wiki.analog.com/_media/resources/tools-software/linux-software/colorimeter_test_setup.png
   :width: 300px
