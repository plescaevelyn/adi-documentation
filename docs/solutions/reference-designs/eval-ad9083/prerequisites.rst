...
#. The AD9083-based evaluation board:
   :adi:`EVAL-AD9083`
#. An FPGA carrier platform. Our recommended ones can be found
   :ref:`here <eval-ad9083 carriers>`.
...
from the FPGA, we use :external+scopy:doc:`Scopy <index>` v2.0 or later (must
