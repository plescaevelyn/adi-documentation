...
This user guide describes the :adi:`AD9694` evaluation board
:adi:`AD9694-500EBZ <EVAL-AD9694>` which provides all of the
support circuitry required to operate the
...
image) and new (second image) versions of the :adi:`AD9694-500EBZ <EVAL-AD9694>`.

.. figure:: images/ad9694_jumpers.jpg
   :align: center
...
The :adi:`AD9694-500EBZ <EVAL-AD9694>` can be evaluated using the
:ref:`ADS7-V2EBZ <ads7-v2>` FPGA data capture board. The
figures below show the :adi:`AD9694-500EBZ <EVAL-AD9694>` connected to the
:ref:`ADS7-V2EBZ <ads7-v2>`. If using the old version of the
board, refer to the first image for connections, otherwise if using the new
version of the board, refer to the second image.

.. figure:: images/ad9694_connection.png
   :align: center
   :width: 800

   (Old) Evaluation Board Connection — :adi:`AD9694-500EBZ <EVAL-AD9694>`

.. figure:: images/ad9694_connection_new_board.jpg
   :align: center
   :width: 800

   (New) Evaluation Board Connection — :adi:`AD9694-500EBZ <EVAL-AD9694>`
...
-  12V, 6.5A switching power supply (such as the SL POWER CENB1080A1251F01
   supplied with :ref:`ADS7-V2EBZ <ads7-v2>` /
   :ref:`ADS7-V1EBZ <ads7-v1>`)
-  PC running Windows®
-  USB 2.0 port
-  :adi:`AD9694-500EBZ <EVAL-AD9694>` board
-  :ref:`ADS7-V2EBZ <ads7-v2>` FPGA-based data capture kit
...
-  Connect the evaluation board to the
   :ref:`ADS7-V2EBZ <ads7-v2>` data capture board, as shown
   in the figure for the **Evaluation Board Connection**.
...
-  Connect one 12V, 6.5A switching power supply (such as the CENB1080A1251F01
   supplied) to P4 on the :ref:`ADS7-V2EBZ <ads7-v2>` board.
   Connect the Standard-B USB port of the
   :ref:`ADS7-V2EBZ <ads7-v2>` board to the PC with the
   supplied USB cable.
-  Turn on the :ref:`ADS7-V2EBZ <ads7-v2>`.
-  The :ref:`ADS7-V2EBZ <ads7-v2>` will appear in the Device
   Manager.
...
.. container:: centeralign
   ...
   \ *Device Manager showing* :ref:`ADS7-V2EBZ <ads7-v2>`\

-  If the Device Manager does not show the
   :ref:`ADS7-V2EBZ <ads7-v2>` listed, unplug all USB
   devices from the PC,
   uninstall and re-install SPIController and VisualAnalog and restart the
...
-  On the :ref:`ADS7-V2EBZ <ads7-v2>` data capture board,
...
.. container:: centeralign
   ...
   \ *Programming the* :ref:`ADS7-V2EBZ <ads7-v2>`\
