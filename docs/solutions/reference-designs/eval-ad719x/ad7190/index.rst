...
The EVAL-AD7190-ASDZ evaluation kit features the AD7190 which is 4.8 kHz
...
The AD7190 ACE Plugin fully configures the AD7190 device register functionality
and provides dc time domain analysis in the form of waveform graphs,
histograms, and associated noise analysis for ADC performance evaluation.

Full specifications on the AD7190 are available in the product data sheet,
which should be consulted in conjunction with this user guide when working with
...
-  :adi:`EVAL-AD7190-ASDZ evaluation board <en/resources/evaluation-hardware-and-software/evaluation-boards-kits/eval-ad7190asdz.html>`
...
-  The :doc:`ACE Plugin software <softwareguide>` is a useful tool to
