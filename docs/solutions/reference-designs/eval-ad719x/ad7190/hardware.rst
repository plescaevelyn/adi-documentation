...
:ref:`Software Procedures <ad7190_software>` section, set up the evaluation and
...
.. list-table::
   ...
   * - LK13
     - Black
     - Uninserted
     - This link shorts AIN1 to AIN2. This is useful to perform noise tests on the AD7190
...
-  External reference can be supplied on P2-2 and P2-3 for REFIN2+ and
   REFIN2-
...
-  :download:`AD7190 Schematic <ad7190_schematic.pdf>`

Bill of Materials
-----------------

-  :download:`AD7190 Bill of Materials <ad7190_bom.pdf>`

:ref:`Next Page: Software Procedures <ad7190_software>`
