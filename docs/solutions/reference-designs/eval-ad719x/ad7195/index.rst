...
The EVAL-AD7195-ASDZ evaluation kit features the AD7195 which is 4.8 kHz
...
The AD7195 ACE Plugin fully configures the AD7195 device register functionality
...
Full specifications on the AD7195 are available in the product data sheet,
...
-  :adi:`AD7195 Data Sheet <ad7195>`

Required Software
-----------------

-  :adi:`ACE Software <EVAL-AD7195ASDZ>`
...
-  :adi:`EVAL-AD7195-ASDZ evaluation board <EVAL-AD7195ASDZ>`
...
-  :ref:`Ace Plugin Install guide available here <ad7195_software>`
...
-  The :ref:`Low Noise Test Demo <ad7195_software>` is a useful demo mode
...
:ref:`Visit the hardware guide chapter here <ad7195_hardware>`

Software Guide
~~~~~~~~~~~~~~

:ref:`Visit the software guide chapter here <ad7195_software>`
