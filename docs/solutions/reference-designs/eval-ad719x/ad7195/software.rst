...
AD7195 product page. Install ACE on a PC **before using** the EVAL-AD7195-ASDZ.
...
:ref:`Software Installation Procedures <ad7195_software>` section and the
:ref:`Evaluation Board Set-up Procedures <ad7195_hardware>` section, set up the
...
- Navigate to the Virtual Eval tool by clicking this link:
  ...
  by going to the AD7195 homepage on analog.com and finding the link there.
