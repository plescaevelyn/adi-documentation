...
.. warning::
   ...
   EVAL-AD7195-ASDZ evaluation board and EVAL-SDP-CB1Z board to the USB port of
   the PC to ensure the PC correctly recognizes the evaluation system.

If you have not set up the EVAL-AD7195-ASDZ and controller board previously
please go to the :ref:`Quick Start Guide <ad7195_index>`

If you have not set up/installed the ACE plugin before please go to
:ref:`Install Guide <ad7195_software>`
...
- The value in the Refin1(+/−) field on the Configuration tab is set to 2.5 V
  ...
  - Information on the reference choice can be viewed in the
    :ref:`Reference Options Tab <ad7195_hardware>`
