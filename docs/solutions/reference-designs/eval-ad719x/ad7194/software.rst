...
Download the ACE software from the ACE software page or the AD7194 product
page. Install ACE on a PC **before using** the EVAL-AD7194-ASDZ.
...
After the AD7194 Plugin is downloaded follow the steps to install the
file: - Double click on the AD7194 Plugin. - Connect up your EVAL-AD7194-ASDZ
to your pc through a controller board. Alternatively, the AD7194 Plugin can be
...
After the EVAL-AD7194-ASDZ and controller board are properly connected to the
PC, launch the ACE software by taking the following steps:

-  From the Start menu of the PC, select All Programs > Analog Devices > ACE>
   ACE.exe to open the ACE software main window shown below
-  If the EVAL-AD7194-ASDZ is not connected to the USB port via the controller
   ...
   AD7194Eval Board icon appear, connect the EVAL-AD7194-ASDZ and the
...
-  Double click the AD7194 chip icon in the AD7194 Eval Board view window to
   open the AD7194 chip view window shown below:
...
-  The “Proceed to Memory Map” button brings the user to the memory map of the
   AD7194. This allows the user to configure the AD7194.
-  The “Proceed to Analysis” button brings the user to the Analysis tab. This
   allows the user to see the performance results of the AD7194 and displays
   the data.
...
-  Navigate to the Virtual Eval tool by clicking this link:
   ...
   or alternatively, by going to the AD7190 homepage on analog.com and finding
   the link there.
