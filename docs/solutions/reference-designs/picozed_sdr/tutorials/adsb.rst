...
-  Radio I/O: `LibIIO client for MATLAB & Simulink <https://wiki.analog.com/resources/tools-software/linux-software/libiio/clients/fmcomms2_3_simulink>`_
-  Hardware targeting:
...
-  :doc:`PicoZed SDR board </solutions/reference-designs/picozed_sdr/picozed_sdr>` is the RF receiver used in this tutorial. To make this board work properly, you will need:

   -  The latest `Zynq image <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_ for the PicoZed SDR board.
   -  `MATLAB Filter Design Wizard for AD9361 <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/filters>`_ to configure the digital filters on :adi:`AD9361`.
   -  A good understanding of how the :adi:`AD9361` works. At a minimum, you should read over a basic intro for the `AD9361 <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/ad9361>`_.
...
To better understand these models, an introduction to IIO System Object provided by ADI can be found `here <https://wiki.analog.com/resources/tools-software/linux-software/libiio/clients/fmcomms2_3_simulink>`_.
...
*adsb.ftr* is a file containing the coefficients of an FIR filter designed using the `Analog Devices AD9361 Filter Design Wizard <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/filters>`_. This tool provides not only a general purpose low pass filter designer, but also magnitude and phase equalization for other stages in the signal path.
...
.. image:: ../images/simulinklibiio.png
   :alt: Block diagram
...
.. image:: ../images/bootbin.png
   :alt: Block diagram

**Step 5: Copy and paste the generated BOOT.BIN onto SD card**

Use the latest `image <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_ from ADI. Replace the BOOT.BIN on SD card with the newly generated BOOT.BIN from HDL Workflow Advisor.
...
Before we use *adsb_decode* to decode real world ADS-B signals, we can verify this file, the new BOOT.BIN, as well as the hardware settings using some pre-captured data and the `ADI IIO Oscilloscope <https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope>`_.
...
.. image:: ../images/softwareinterfacemdl.png
   :alt: Block diagram
...
.. image:: ../images/externalresult.png
   :alt: Block diagram
...
.. |Block diagram| image:: ../images/fig8.png
   :width: 700
.. |image1| image:: ../images/table.png
   :width: 700
.. |image2| image:: ../images/install.png
.. |image3| image:: ../images/step4.3.png
.. |image4| image:: ../images/winscp.png
.. |image5| image:: ../images/oscverify_results.png
.. |image6| image:: ../images/result.png
