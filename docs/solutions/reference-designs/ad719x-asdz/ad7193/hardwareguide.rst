...
After following the instructions in the :doc:`Software Procedures <softwareprocedures>` section, set up the evaluation and SDP boards as detailed in this section.

-  **Warning:** The evaluation software and drivers must be installed
   before connecting the EVAL-AD7193ASDZ evaluation board and
...
:doc:`Next Page: Software Procedures <softwareprocedures>`
