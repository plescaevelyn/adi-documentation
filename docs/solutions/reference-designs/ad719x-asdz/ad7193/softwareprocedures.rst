...
After completing the steps in the :doc:`Software Installation Procedures <softwareprocedures>` section and the :doc:`Evaluation Board Set-up Procedures <hardwareguide>` section, set up the system for data capture by taking the following steps:
