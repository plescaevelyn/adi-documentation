...
The EVAL-AD7194ASDZ evaluation kit features the AD7194 which is 4.8 kHz
...
The AD7194 ACE Plugin fully configures the AD7194 device register
...
Full specifications on the AD7194 are available in the product data sheet,
which should be consulted in conjunction with this user guide when working
with the evaluation board.

.. image:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7194_blockdiag.png
   :align: center
   :width: 600
...
-  :doc:`AD7194 Firmware </wiki-migration/resources/tools-software/product-support-software/ad719x_mbed_iio_application>`
