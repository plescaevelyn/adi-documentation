...
-  1x :adi:`ADS10 Evaluation Platform
   <en/products/adrv9040.html#evaluation-kit>`
-  1x :adi:`EVAL-ADRV904x` Transceiver Evaluation Board
-  1x Signal Generator for generating clock to the ADRV904x Evaluation Board
-  1x Host Computer and an ethernet cable to connect the Host Computer to ADS10
   Evaluation Platfrom
