...
After booting process is complete, you can open IIO-Oscilloscope. Learn more about it `here <https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope>`_. You can interact with the IIO-Osc GUI either directly or over the network.
