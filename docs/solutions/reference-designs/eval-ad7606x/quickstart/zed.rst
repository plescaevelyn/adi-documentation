...
.. collapsible:: Complete boot log
   ...
   ::
      ...
      ad7606x: Initializing...
      ad7606x: SPI initialized successfully.
      ad7606x: Device ad7606b detected.
      ad7606x: Oversampling ratio set to 0 (no oversampling).
      ad7606x: Range set to +/-10V on all channels.
      ad7606x: Successfully initialized.

      Channel 0: 0x0000 (  0.000 V)
      Channel 1: 0x0000 (  0.000 V)
      Channel 2: 0x0000 (  0.000 V)
      Channel 3: 0x0000 (  0.000 V)
      Channel 4: 0x0000 (  0.000 V)
      Channel 5: 0x0000 (  0.000 V)
      Channel 6: 0x0000 (  0.000 V)
      Channel 7: 0x0000 (  0.000 V)
