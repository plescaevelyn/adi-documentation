...
This guide provides some quick instructions (still takes a while to download, and
set things up) on how to setup the :adi:`AD-FMCDAQ2-EBZ` / :adi:`AD-FMCDAQ3-EBZ` on:
...
-  Xilinx XSCT/XSDB (included in Vivado/Vitis installation).
...
- Open XSCT/XSDB console to configure the FPGA and download the elf image.
...
.. collapsible:: Click to expand
   ...
   ::
         ...
         * XMD v2014.2 (64-bit)
         ...
         XMD% dow /home/microblaze/linux/arch/microblaze/boot/simpleImage.kcu105_ad_fmcdaq2_ebz
         System Reset .... DONE
         Downloading Program -- /home/microblaze/linux/arch/microblaze/boot/simpleImage.kcu105_ad_fmcdaq2_ebz
...
.. collapsible:: Click to expand
   ...
   ::
      ...
      * Xilinx hw_server v2021.1
      ...
      xsdb% target 3
      xsdb% dow simpleImage.kc705_fmcdaq2.strip
      Downloading Program -- /home/microblaze/microblaze/simpleImage.kc705_fmcdaq2/simpleImage.kc705_fmcdaq2.strip
      ...
      Successfully downloaded /home/microblaze/microblaze/simpleImage.kc705_fmcdaq2/simpleImage.kc705_fmcdaq2.strip
...
If your FPGA carrier board (:xilinx:`KC705`, :xilinx:`VC707`, :xilinx:`ML605`) features a LCD display and the board is connected to a DHCP enabled network. You should also see its IP address printed on the display. This allows you to connect remote to the board as well. (ssh, libiio remote)
...
Please see also here: :ref:`IIO Oscilloscope <iio-oscilloscope>`
