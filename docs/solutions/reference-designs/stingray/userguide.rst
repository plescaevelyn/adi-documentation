...
-  `ADAR1000 Datasheet and Silicon Errata <https://wiki.analog.com/resources/errata/adar1000>`_
...
-  `Assembly Drawing <resources/stingray_assembly_v2.pdf>`_
-  `Board Dimensions <resources/stingray_dimensions.zip>`_
-  Rev. A design:

   -  `Schematic <resources/059522a_modified.pdf>`_
   -  `BOM <resources/059522a_bom.zip>`_

-  Rev. B/C design:

   -  `Schematic <resources/02_059522b_top.pdf>`_
   -  `BOM <resources/059522b_bom.zip>`_
...
-  `Basic SDP Test Program <resources/stingray_test.zip>`_ (Windows 10 might try to block this, you'll have to explicitly allow it in your security settings)
...
-  :git-linux:`ADAR1000 LibIIO Linux Driver <drivers/iio/beamformer/adar1000.c>`
   ...
   -  `Driver Documentation <https://wiki.analog.com/resources/tools-software/linux-drivers/iio-transceiver/adar1000>`_
...
-  The platform should now be fully assembled. Compare the result to the `assembly drawing <resources/stingray_assembly_v2.pdf>`_ to ensure proper assembly.
...
.. note::
   ...
   **BE SURE TO CONFIGURE THE LTC2992 SUCH THAT ALL
   ...
   GPIO PINS ARE HI-Z! SEE `CONFIGURING THE LTC2992 <https://wiki.analog.com/>`_\ \*\4. Initialize the ADAR1000s to put the ADAR1000-EVAL1Z into a known safe state with the ADTR1107 PAs pinched off. See the :doc:`Recommended ADAR1000 Initialization Sequences </solutions/reference-designs/stingray/userguide>` section for a recommended set of SPI writes.
...
.. note::
   ...
   The below sequences don't take into account the issues described in the `ADAR1000 Silicon & Datasheet Errata <https://wiki.analog.com/resources/errata/adar1000>`_. Consult these documents for more information about how to properly communicate with all parts on the board.
...
.. image:: images/channel_mapping_reverse.png
...
:doc:`ADAR1000EVAL1Z Homepage </solutions/reference-designs/stingray/stingray>`

`X Band Development Platform <https://wiki.analog.com/resources/eval/user-guides/x-band-platform>`_

.. |image1| image:: images/adar1000eval1z_bottom-web.gif
   :width: 200

.. |image2| image:: images/adar1000eval1z_top-web.gif
   :width: 200

.. |image3| image:: images/adar1000eval1z_top_kit.jpg
   :width: 200

.. |image4| image:: images/adar1000eval1z_bottom_kit-web.jpg
   :width: 200

.. |ADAR1000-EVAL1Z Component Side Overview| image:: images/component_side_overview.png
   :width: 1300

.. |ADAR1000-EVAL1Z Antenna Side Overview| image:: images/antenna_side_overview.png
   :width: 800

.. |PMOD Pinout| image:: images/pmod_pinout.png
   :width: 600

.. |CSB Selector Switches| image:: images/csb_selectors.jpg
