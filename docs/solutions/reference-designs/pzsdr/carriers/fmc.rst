...
The `ADRV9361-Z7035 <https://wiki.analog.com/resources/eval/user-guides/adrv936x_rfsom/hardware>`_ will work with the FMC Carrier, and all functionality of the carrier is supported.

ADRV9364-Z7020
~~~~~~~~~~~~~~

The `ADRV9364-Z7020 <https://wiki.analog.com/resources/eval/user-guides/adrv936x_rfsom/hardware>`_ will work with the FMC Carrier, but not all carrier functionality is supported. The things that will work:
