...
.. _ad_fmcdaq3_ebz introduction:

Introduction
============

The :adi:`AD-FMCDAQ3-EBZ` module is comprised of the :adi:`AD9680` dual, 14-bit,
1.25 GSPS, JESD204B ADC, the :adi:`AD9152` dual, 16-bit, 2.5 GSPS, JESD204B DAC,
the :adi:`AD9528` clock, and power management components. It is clocked by an
...
platform. In an FMC footprint (84 mm × 69 mm), the module's combination of
...
signal chain performance. For additional information or to purchase the
AD-FMCDAQ3-EBZ, please visit: :adi:`AD-FMCDAQ3-EBZ`
