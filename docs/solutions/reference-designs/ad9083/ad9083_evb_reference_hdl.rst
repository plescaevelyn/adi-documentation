...
`ad9083 <https://wiki.analog.com/resources/eval/ad9083>`_
...
.. image:: images/ad9083_evb_a10soc.svg
   :width: 800
...
A more comprehensive build guide can be found in the `HDL User Guide <https://wiki.analog.com/resources/fpga/docs/hdl>`_.
...
-  `Evaluating Using the ADS8-V3EBZ FPGA-Based Capture Board <https://wiki.analog.com/resources/eval/ad9083>`_
-  `AD9083 Linux Driver <https://wiki.analog.com/resources/tools-software/linux-drivers/iio-adc/ad9083>`_
