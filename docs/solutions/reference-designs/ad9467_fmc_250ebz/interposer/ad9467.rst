...
.. important::
   ...
   This design is not supported anymore, thus this wiki page is kept for legacy purposes only. The similar design with an FMC connector is still supported and can be found here :doc:`AD9467 Native FMC Card / Xilinx Reference Design </wiki-migration/resources/fpga/xilinx/fmc/ad9467>`\
...
-  :adi:`AD9467 Evaluation Board <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/EVAL-AD9467.html#eb-overview>`
-  :adi:`ADC-FMC Interposer A <en/evaluation/eval-adc-fmc-int/eb.html>`
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_setup.jpg
   :alt: Hardware setup
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_impact.jpg
   :alt: IMPACT
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_uart.jpg
   :alt: Terminal
   :width: 200px
...
.. image:: https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_chipscope.jpg
   :alt: Chipscope Busplot
   :width: 200px
...
.. admonition:: Download
   ...
   -  **ML605** `cf_ad9467_ebz_edk_14_4_2013_03_08.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_edk_14_4_2013_03_08.tar.gz>`_
   -  **KC705** `cf_ad9467_ebz_kc705_edk_14_4_2013_03_08.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_kc705_edk_14_4_2013_03_08.tar.gz>`_
   -  **VC707** `cf_ad9467_ebz_vc707_edk_14_4_2013_03_08.tar.gz <https://wiki.analog.com/_media/resources/fpga/xilinx/interposer/cf_ad9467_ebz_vc707_edk_14_4_2013_03_08.tar.gz>`_
   


Only Xilinx coregen xco files are provided with the reference design. You must regenerate the IP core files using this file. See :doc:`generating Xilinx netlist/verilog files from xco files </wiki-migration/resources/eval/user-guides/ad-fmcomms1-ebz/reference_hdl>` for details.
...
**As this design is obsolete, we do not fully support it anymore**. Analog Devices will provide **limited** online support for anyone using the reference design with Analog Devices components via the :ez:`EngineerZone FPGA reference designs <community/fpga>` forum.
