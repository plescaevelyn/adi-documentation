...
The :adi:`X-Band Development Platform <en/design-center/evaluation-hardware-and-software/evaluation-boards-kits/x-band-development-platform.html>` contains one :adi:`AD9081-FMCA-EBZ <eval-ad9081>` AD9081 MxFE Evaluation Board, one `ADXUD1AEBZ <https://wiki.analog.com/resources/eval/user-guides/xud1a>`_ X/C Band Up/Down Converter, and one `ADAR1000EVAL1Z <https://wiki.analog.com/resources/eval/user-guides/stingray>`_ X/Ku-Band Analog Beamforming Board. The target application is phased array radars, electronic warfare, and ground-based SATCOM, specifically a X Band 32 transmit/32 receive channel hybrid beamforming phased array.
...
-  :doc:`Hardware </solutions/reference-designs/x-band-platform/hardware>`

Software
--------

-  :doc:`Software </solutions/reference-designs/x-band-platform/software>`
...
-  `ADXUD1AEBZ <https://wiki.analog.com/resources/eval/user-guides/xud1a>`_

ADAR1000EVAL1Z
~~~~~~~~~~~~~~

-  `ADAR1000EVAL1Z <https://wiki.analog.com/resources/eval/user-guides/stingray>`_
...
.. |1000| image:: images/xbdp-wiki-system-block-diagram.png
