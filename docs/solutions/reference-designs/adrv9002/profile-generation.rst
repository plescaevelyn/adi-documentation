...
.. figure:: images/tes_main_configuration_4.png
   :align: center
...
.. figure:: images/tes_save_profile_and_stream_2.png
   :align: center
...
.. figure:: images/tes_enable_nco_correction_2.png
   :align: center
...
.. figure:: images/tes_diversity_settings_2.png
   :align: center
...
.. warning::
    ...
    This setting is only available if TDD is set in the **Device
    Configuration** tab.

Enable Frequency hopping
^^^^^^^^^^^^^^^^^^^^^^^^

.. figure:: images/test_fh_enablement_2.png
   :align: center

.. note::

    The only thing needed to do in TES is to enable Frequency hopping
    as highlighted. All the other settings do not map to any profile
    setting.
