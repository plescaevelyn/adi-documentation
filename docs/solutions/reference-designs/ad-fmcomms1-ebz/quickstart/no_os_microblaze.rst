...
-  After `building the project in Vivado <https://wiki.analog.com/resources/fpga/docs/build>`_ for the used FPGA board, a **SDK_Export** folder will be created in **../fmcomms1_board.sdk/SDK**
