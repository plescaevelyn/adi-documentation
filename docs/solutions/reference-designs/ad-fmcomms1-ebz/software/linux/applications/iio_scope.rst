...
The application can be used to connect to another platform that runs no-OS software: `iio <https://wiki.analog.com/resources/tools-software/no-os-software/iio>`_
...
.. image:: ../../../images/osc_saveas_window.png
...
.. image:: ../../../images/channel_settings_menu.png
...
.. image:: ../../../images/trigger_settings.png
   :align: right
   :width: 250
...
Several waveforms are provided with the application for demonstration purposes, which can be loaded into different devices. However, these are generally not meant for transceiver characterization or demodulation. If you want to do such tasks, we would recommend creation of your own waveforms from tools such as `MATLAB <https://wiki.analog.com/resources/eval/user-guides/ad-fmcomms2-ebz/software/basic_iq_datafiles>`_.
...
If you want to make your own plugin, please refer to the `Internals <https://wiki.analog.com/resources/tools-software/linux-software/iio_scope/internals>`_ page.

More information
----------------

-  `AD-FMCOMMS1-EBZ Reference Design <https://wiki.analog.com/resources/fpga/xilinx/fmc/ad-fmcomms1-ebz>`_
-  `Linux with HDMI video output on the ZED and ZC702 boards <https://wiki.analog.com/resources/tools-software/linux-drivers/platforms/zynq>`_
...
.. |IIO Oscilloscope disconnect plugins| image:: ../../../images/plugin_disconnect_button.png
   :width: 400

.. |IIO Oscilloscope plot window| image:: ../../../images/osc_plot_window.png
   :width: 500
