...
-  QR code scanner
-  For the FMCOMMS2/3/4: Frequency counter with a USB-GPIB port (tested with an
   HAMEG Instruments, HM8123,5.12) and with a probe and grounding clip
   attachment
...
.. note::
   ...
   Before testing the board, please make sure to add a QR code sticker with the
...
-  If the DCXO test has been completed, the PASSED message will appear on the
   screen
...
-  If connections are OK, the test will begin. Below is an example of a test
   running:

.. image:: images/test_6.png
   :align: right

-  If the FMCOMMS test has been completed, the PASSED message will be printed on
   the screen. This means that the DUT passed all the assigned tests.
...
-  Remove the FMCOMMS card and previously used board. Return to step 1 with the
   next board.
...
.. |image1| image:: images/picture2.png
.. |image2| image:: images/frequency_counter.png
   :width: 600
.. |image3| image:: images/wifi_connection.png
   :width: 600
.. |fmcomms3-loopback.jpg| image:: images/fmcomms3-loopback.jpg
.. |fmcomms4-loopback.jpg| image:: images/fmcomms4-loopback.jpg
.. |fmcomms5-loopback.jpg| image:: images/fmcomms5-loopback.jpg
