.. _fmcomms2 hardware certification:

Certification
===============================================================================

Both `CE <https://en.wikipedia.org/wiki/CE_marking>`_ and `FCC
<https://en.wikipedia.org/wiki/FCC_Declaration_of_Conformity>`_ are necessary
