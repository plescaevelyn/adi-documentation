...
-  :doc:`Building the ZynqMP / MPSoC Linux kernel and devicetrees from source </solutions/reference-designs/fmcomms2/software/linux/zynqmp>`
...
-  SD Card 16GB or more, image with the latest image available, using the instructions here: `Zynq & Altera SoC Quick Start Guide <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_
