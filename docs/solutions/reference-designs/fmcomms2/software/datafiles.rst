...
the FMComms2 / FMComms3 and test your board. By changing the given Simulink
models, you can easily generate your own data files.
...
Once files have been created by MATLAB/Simulink, they can be `transferred to the target <https://wiki.analog.com/resources/tools-software/linux-software/kuiper-linux>`_.
...
Since we would like to transmit the QPSK at a sample rate of 20M Symbols/s with
...
.. admonition:: Download
   ...
   -  `qpsknofilt_model.zip <../resources/qpsknofilt_model.zip>`_
...
.. admonition:: Download
   ...
   -  `qpsknofilt_data.zip <../resources/qpsknofilt_data.zip>`_
...
.. admonition:: Download
   ...
   -  `qpskwithfilt_model.zip <../resources/qpskwithfilt_model.zip>`_
...
.. admonition:: Download
   ...
   -  `qpskwithfilt_txt.zip <../resources/qpskwithfilt_txt.zip>`_
...
Before you look at the IIO Oscilloscope  [2]_, make sure the sampling rate of
ADC and DAC is set at 30.72 MSPS, as shown in the figure below. Otherwise, it
may incur some problems. In this panel, there are quite a few other parameters
you can tune (DCXO, RF Bandwidth, LO Frequency), in order to get the optimal
...
.. admonition:: Download
   ...
   -  `qpskwithfilt_mat.zip <../resources/qpskwithfilt_mat.zip>`_
   
   You can download the receiver model from below:
   
   -  `qpsk_receiver_new.zip <../resources/qpsk_receiver_new.zip>`_
...
.. admonition:: Download
   ...
   -  `qam16_model.zip <../resources/qam16_model.zip>`_
...
.. admonition:: Download
   ...
   -  `qam16_20.zip <../resources/qam16_20.zip>`_
...
.. admonition:: Download
   ...
   -  `qam16_receiver.zip <../resources/qam16_receiver.zip>`_
...
.. admonition:: Download
   ...
   -  `msk_model.zip <../resources/msk_model.zip>`_
...
.. admonition:: Download
   ...
   -  `msk_20mdata.zip <../resources/msk_20mdata.zip>`_
...
.. admonition:: Download
   ...
   -  `msk_20.zip <../resources/msk_20.zip>`_
...
.. admonition:: Download
   ...
   -  `msk_receiver.zip <../resources/msk_receiver.zip>`_
...
.. admonition:: Download
   ...
   -  `lte_model.zip <../resources/lte_model.zip>`_
...
.. admonition:: Download
   ...
   -  `lte_data.zip <../resources/lte_data.zip>`_
   
   It is in the same format as the data in previous sections.

.. [1]
   `Root-raised-cosine filter <https://en.wikipedia.org/wiki/Root-raised-cosine_filter>`_
...
.. |Subsystem diagram| image:: ../images/qpskwithfilter.png
   :width: 900
.. |image1| image:: ../images/resultwithfilt.png
   :width: 900
.. |iiosetting_new.png| image:: ../images/iiosetting_new.png
   :width: 500
.. |qpsk_waveform_verify_new.png| image:: ../images/qpsk_waveform_verify_new.png
   :width: 450
.. |image2| image:: ../images/16qam.png
   :width: 900
.. |qam16_verified.png| image:: ../images/qam16_verified.png
   :width: 700
.. |image3| image:: ../images/msk.png
   :width: 900
.. |msk_receiver.png| image:: ../images/msk_receiver.png
   :width: 700
