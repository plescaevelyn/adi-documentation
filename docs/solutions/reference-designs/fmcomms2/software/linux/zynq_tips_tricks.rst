...
operating system, many aspect of the hardware can be described
in a data structure that is passed to the operating system at
boot time.

For your convenience -- all device tree files (dtb) for our
designs are included in the SD Card boot partition. Sometimes
it's desired to change certain device tree properties
permanently.
...
- Mount the FAT32 Boot partition by clicking on the
  537MB Volume Icon on the desktop
- Open a shell by clicking ion the Terminal Icon on the
  desktop (or CTRL+ALT+t)
