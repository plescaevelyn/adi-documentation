...
For information about the transmit and receive paths consult :doc:`AD9361, AD9363, AD9364 transceiver outline </solutions/reference-designs/fmcomms2/ad9361>`. This also includes information on alternative solutions for programming the transceiver's filters.
...
.. [2]
   `IIO_Oscilloscope <https://wiki.analog.com/resources/tools-software/linux-software/iio_oscilloscope>`_

.. [3]
   `Butterworth filter design <https://www.mathworks.com/help/signal/ref/butter.html>`_

.. [4]
   `FIR filter-based interpolator <https://www.mathworks.com/help/dsp/ref/mfilt.firinterp.html>`_

.. [5]
   `Arbitrary response magnitude filter specification object <https://www.mathworks.com/help/dsp/ref/fdesign.arbmag.html?searchHighlight=fdesign.arbmag&s_tid=srchtitle>`_
