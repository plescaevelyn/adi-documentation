.. _pulsar-adc quickstart coraz7s:

CoraZ7-07S
===============================================================================

This guide provides quick instructions on how to set up the :adi:`EVAL-ADAQ40xx`
on:
...
- Instructions on how to manually build the boot files from source can be found
  ...
  - :external+hdl:ref:`pulsar_adc` build documentation. More HDL build details at
...
.. important::
   ...
   (e.g., ``zynq-coraz7s-ad7685-pmdz.dtb`` for the AD7685).
...
- `Cora Z7S
  <https://digilent.com/shop/cora-z7-zynq-7000-single-core-for-arm-fpga-soc-development>`__
  FPGA board
- :adi:`EVAL-ADAQ40xx` evaluation board (PMOD variant)
...
EVAL-ADAQ40xx/CoraZ7-07S
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

.. figure:: ../images/adaq4003_coraz7s.jpg
   :align: center
   :width: 500

   EVAL-ADAQ40xx/CoraZ7-07S hardware setup for Linux.

In the following example, we will prepare the evaluation setup by connecting the
:adi:`EVAL-ADAQ40xx` board to the CoraZ7-07S and applying a test input signal.
...
#. Plug-in an Ethernet cable from your router/switch to the Ethernet port on the
   ...
   .. admonition:: Info
      ...
      that is still possible, but requires some extra configuration. Set a
      static IP on the board and on your PC's Ethernet adapter within the same
      subnet (e.g., board: ``192.168.1.10``, PC: ``192.168.1.1``).

#. Using the PMOD connector, plug the :adi:`EVAL-ADAQ40xx` on top of the
   CoraZ7-07S
#. Connect your signal source to the analog input connectors on the
   :adi:`EVAL-ADAQ40xx`
...
.. collapsible:: Complete boot log
      ...
      ::
         ...
         reading uImage
         9122840 bytes read in 526 ms (16.5 MiB/s)
         reading devicetree.dtb
         16751 bytes read in 28 ms (584 KiB/s)
         ** Unable to read file uramdisk.image.gz **
         ...
         ## Flattened Device Tree blob at 02a00000
            ...
            Loading Device Tree to 1eb17000, end 1eb1e16e ... OK
         ...
         Memory: 358776K/524288K available (13312K kernel code, 912K rwdata, 11076K rodata, 1024K init, 498K bss, 33480K reserved, 131072K cma-reserved, 0K highmem)
         ...
         axi_sysid 45000000.axi-sysid-0: [pulsar_adc] on [coraz7s] git branch <hdl_2026_r1> git <a77599a506f259d09aa871459427287a7cb92ebc> clean [2026-04-22 12:07:26] UTC
         ...
         systemd-journald[82]: Collecting audit messages is disabled.
         ...
         systemd[1]: Finished systemd-tmpfiles-setup-dev-early.service - Create Static Device Nodes in /dev gracefully.
...
.. shell::
   ...
   $iio_info | grep iio:device
       iio:device0: xadc
       iio:device1: adaq4003 (buffer capable)
...
.. figure:: ../images/pulsar_adc_scopy_channel1_coraz7s.png
   :width: 700

   Scopy data capture from PulSAR ADC on CoraZ7-07S (Channel 1)

.. figure:: ../images/pulsar_adc_scopy_channel2_coraz7s.png
   :width: 700

   Scopy data capture from PulSAR ADC on CoraZ7-07S (Channel 2)
...
#. Press ``Refresh`` to display available IIO Devices and press ``Connect``.
   ...
   .. figure:: ../images/pulsar_adc_iio_osc_connect_coraz7s.png
      :width: 700
...
#. After the board is connected and a channel is enabled, hit the play button.
   ...
   .. figure:: ../images/pulsar_adc_iio_osc_plot_coraz7s.png
      :width: 700
