...
#. Connect the :adi:`EVAL-CN0506-FMCZ` to the low pin count (LPC) FMC connector 
   on the ZC706 evaluation board.

   .. image:: ../images/zc706_cn0506.jpg
      :align: center
      :width: 500
...
#. Plug the power cord into the 12 V power jack 2×6 connector J22.
   ...
   .. attention::
      ...
      Guide <https://www.xilinx.com/support/documentation/boards_and_kits/zc706/ug954-zc706-eval-board-xc7z045-ap-soc.pdf>`_
      for detailed default jumper settings information.

   .. image:: ../images/zc706_power.jpg
      :align: center
      :width: 500
...
#. In your flashed Linux Image BOOT partition, copy the kernel to the root 
   ...
   ZC706, copy the uImage file in the **zynq-common** folder to the root 
