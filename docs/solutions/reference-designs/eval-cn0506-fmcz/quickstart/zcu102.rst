.. _eval-cn0506-fmcz quickstart zcu102:

CN0506 + ZCU102 Quickstart
===============================================================================
...
- Xilinx :xilinx:`ZCU102` Evaluation Board Rev 1.0 or a later version
...
- `CP2103 USB to UART Bridge Driver <https://www.silabs.com/developers/usb-to-uart-bridge-vcp-drivers>`__
...
#. Connect the ZCU102 USB-to-UART Bridge with Micro USB Connector (J83) to 
   the host PC using a micro USB cable.
...
#. Plug the power cord into the 12 V power jack 2×6 connector J22.
   ...
   .. attention::
      ...
      switch and jumper settings are in default mode. Refer to the ZCU102 User 
      Guide for detailed default jumper settings information.
...
#. In your flashed Linux Image BOOT partition, copy the kernel to the root 
   ...
   ZCU102, copy the Image file in the **zynqmp-common** folder to the root 
   folder or just outside the folder of the kernel.

#. Copy the boot files to the root folder. The boot files can be found in the 
   **zynqmp-zcu102-rev10-cn0506-mii** or **zynqmp-zcu102-rev10-cn0506-rgmii** folder 
   depending on your needs. In this guide, we will copy all the files inside 
   **zynqmp-zcu102-rev10-cn0506-mii** folder to the root folder.
...
#. Safely eject the SD Card from your host PC and insert it into your ZCU102 
   SD Card Interface Connector (J30).

   .. image:: ../images/zcu102_sdcard.jpg
      :align: center
      :width: 500
   ...
   .. admonition:: Linux BOOT messages
      ...
      ::
         ...
         ** Unable to read file uramdisk.image.gz **
         ...
         OF: fdt: Machine model: Xilinx Zynq ZCU102
...
#. Connect the UART USB Cable connection from ZCU102 to your Host PC. Your Host 
...
#. Bridge network connections so we can install necessary tools such as iPerf3 
   for ZCU102 through the Internet. Go to Control Panel > Network and Internet > 
