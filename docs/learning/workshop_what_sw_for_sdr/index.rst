...
.. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/theoretical_content/customer_design_flow.png
...
Analog Devices provides a single cohesive software solution, meeting customers in their ecosystem or at their tools of choice.
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/theoretical_content/sw_solution.png
...
ADI's modular architecture provides reusable building blocks that accelerate development and create opportunities for new applications and revenue streams.
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/theoretical_content/building_blocks.png
...
The common architecture across ADI's platforms makes it easy to transition between hardware as your project evolves from prototype to production.
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/theoretical_content/common_architecture.png
...
This generic approach means you can use the same plugin to control different ADI evaluation boards without requiring board-specific software.
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/adgeneric_iio_board_plugin.png
...
* **Remote operation**: Can connect to IIO devices over network using iiod
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/iio_scope.png
...
* **DMM (Digital Multimeter) Plugin**:
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/dmm_plugin.png
...
* **Debug Tab/Plugin**:
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/debug_tab.png
...
* **High Level Device Control Plugins**:
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/fpga_settings.png
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/high_level_device_ctrl.png
...
* **Export capabilities**: Save data, screenshots, and configurations for documentation
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/scopy_interface.png
...
* **Recording and playback**: Capture RF signals for offline analysis
   ...
   .. figure:: workshop_just_enough_sw_and_hdl_for_high_speed_designs/images/analysis_control_eval/qiq_receiver.png
