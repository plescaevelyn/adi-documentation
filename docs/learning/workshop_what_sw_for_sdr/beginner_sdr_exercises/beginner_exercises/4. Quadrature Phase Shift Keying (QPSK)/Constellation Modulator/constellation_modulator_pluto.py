...
# Title: constellation_modulator_pluto
...
class constellation_modulator_pluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "constellation_modulator_pluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("constellation_modulator_pluto")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "constellation_modulator_pluto")
        ...
        self._offset_rx_range = qtgui.Range(-250000, 250000, 1, -100000, 200)
...
def main(top_block_cls=constellation_modulator_pluto, options=None):
