...
# Title: console_message_receiver_pluto
...
import configparser
import console_message_receiver_pluto_epy_block_0_0 as epy_block_0_0  # embedded python block
import math
import sip
import threading
...
class console_message_receiver_pluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "console_message_receiver_pluto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("console_message_receiver_pluto")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "console_message_receiver_pluto")
        ...
        self.qtgui_eye_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 1, 0, 0, "")
        ...
        self.qtgui_const_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 1, 0, "")
        ...
        self.iio_pluto_sink_0.set_attenuation(0, -80)
        ...
        self.digital_correlate_access_code_xx_ts_0 = digital.correlate_access_code_bb_ts("11100001010110101110100010010011",
          1, 'packet_len')
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(constellation, (2*math.pi*0.01), (-math.pi), math.pi)
        ...
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, offset_rx, 0, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.iio_pluto_sink_0, 0))
    ...
    def set_offset_rx(self, offset_rx):
        ...
        self.analog_sig_source_x_0_0_0_0.set_frequency(self.offset_rx)
...
def main(top_block_cls=console_message_receiver_pluto, options=None):
