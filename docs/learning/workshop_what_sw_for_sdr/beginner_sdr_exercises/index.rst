...
.. important::
   ...
   Download the exercise files before starting (regardless of used platform):
   ...
   .. tab-item:: Raspberry Pi 5
      ...
      (Python, GNU Radio, Thonny IDE, Scopy, PyADI-IIO, and all required libraries).
         ...
         .. important::
            ...
            The Raspberry Pi 5 SD card image can be downloaded
            `here <https://swdownloads.analog.com/cse/kuiper/kuiperv2.0.0/workshop-sdr/sdr_workshop_rpi_image.zip>`__.
...
.. important::
   ...
   `here <https://swdownloads.analog.com/cse/kuiper/kuiperv2.0.0/workshop-sdr/sdr_workshop_jupiter_image.zip>`__.
...
**Connecting to Jupiter via SSH:**

To communicate with the Jupiter, open a terminal and connect via SSH:
