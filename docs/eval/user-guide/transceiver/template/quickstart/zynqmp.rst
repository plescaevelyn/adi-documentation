...
can build them manually. In the following sections, we explain how to
take them from the SD card.
...
- no-OS documentation for building a project
- :external+hdl:ref:`adrv9026`. More HDL build details at
  :external+hdl:ref:`build_hdl`.
