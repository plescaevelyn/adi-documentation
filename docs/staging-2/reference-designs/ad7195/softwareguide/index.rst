.. imported from: https://wiki.analog.com/resources/eval/user-guides/ad7195/softwareguide

.. _ad7195 softwareguide:
...
Download the ACE software from the ACE software page or the AD7195 product page.
Install ACE on a PC **before using** the EVAL-AD7195ASDZ.
...
#. Hit the + button next to the Zipped Plug-in Sources.
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7195/ad7195ace.png
      :width: 400px
...
#. If the EVAL-AD7195ASDZ is not connected to the USB port via the controller
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7195/ad7195attachhardware.png
      :width: 400px

#. Double click the AD7195 Eval Board icon to open the AD7195 Eval Board view
   window shown below:

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7195/ad7195boardview.png
      :width: 400px

#. Double click the AD7195 chip icon in the AD7195 Eval Board view window to
   open the AD7195 chip view window shown below:

#. Click Software Defaults and then click Apply Changes to apply the default
   settings to the AD7195 (see figure below)

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7195/ad7195cipview.png
      :width: 400px
...
:dokuwiki:`Software Installation Procedures </resources/eval/user-guides/AD7195/softwareguide#ace_plugin_install_guide>`
section and the
:dokuwiki:`Evaluation Board Set-up Procedures </resources/eval/user-guides/AD7195/hardwareguide#set-up_procedures>`
...
#. The ``Proceed to Memory Map`` button brings the user to the memory map of the
   AD7195. This allows the user to configure the AD7195.
...
The Result section shows the analysis of the channel selected .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7190/ad7192_waveformpage.png
   :width: 400px
...
For more information of the register and the bitfields in the register, double click on the register shown by label 2. This will show up the register description shown by label 6.\ .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7190/ad7192_memory_page.png
   :width: 600px
...
:dokuwiki:`Visit the demo mode section here </resources/eval/user-guides/ad7195/softwareguide/demo_modes>`
**Contents of the demo modes section:**

#. :dokuwiki:`Low Noise Test Demo </resources/eval/user-guides/ad7195/softwareguide/demo_modes#low_noise_test_demo>`
#. :dokuwiki:`Weigh scale Demo </resources/eval/user-guides/ad7195/softwareguide/demo_modes#weigh_scale_demo_test>`
...
#. Navigate to the Virtual Eval tool by clicking this link:
   ...
   alternatively, by going to the AD7193 homepage on analog.com and finding the
   link there.

#. Select the AD7193 by going to "Precision ADC < 10MSPS" and finding the part
   there.

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad7190/ad719x_virtual_eval.png
      :width: 600px
...
:dokuwiki:`Previous Page: Hardware Guide </resources/eval/user-guides/ad7195/hardwareguide>`

:dokuwiki:`Return to Homepage </resources/eval/user-guides/ad7195>`
