.. imported from: https://wiki.analog.com/resources/eval/user-guides/ad4170/softwareprocedures

.. _ad4170 softwareprocedures:
...
Download the ACE software from the ACE software page or the AD4170 product page.
Install ACE on a PC **before using** the EV-AD4170-ASD1Z-U1.
...
#. Under ``Special Resources`` click on the link call ``AD4170 ACE Plug In V 1.0
   ...
   downloading. :red:`REPLACE with 4170 type`

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/4170_ace_plugin_download_page_1.png
      :width: 400px
...
#.  Read the software license agreement, click the checkbox and I Accept
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/4170_ace_plugin_download_page_2.png
      :width: 400px
...
#. If the EV-AD4170-ASD1Z-U1 is not connected to the USB port via the controller
   ...
   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/4170_ace_plugin_launch_page_2.png
      :width: 400px

#. Double click the AD4170 Eval Board icon to open the AD4170 Eval Board view
   window shown below:

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/4170_ace_plugin_launch_page_3.png
      :width: 400px

#. Double click the AD4170 chip icon in the AD4170 Eval Board view window to
   open the AD4170 chip view window shown below:

#. Click Software Defaults and then click Apply Changes to apply the default
   settings to the AD4170 (see figure below)

   .. figure:: https://wiki.analog.com/_media/resources/eval/user-guides/ad4170/4170_ace_plugin_launch_page_4.png
      :width: 400px
...
:dokuwiki:`Software Installation Procedures </resources/eval/user-guides/ad4170/softwareprocedures#ace_plugin_install_guide>`
section and the
:dokuwiki:`Evaluation Board Set-up Procedures </resources/eval/user-guides/ad4170/hardwareguide#set-up_procedures>`
...
#. The ``Proceed to Memory Map`` button brings the user to the memory map of the
   AD4170. This allows the user to configure the AD4170.
...
:dokuwiki:`Visit the demo mode section here </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes>`
**Contents of the demo modes section:**

#. :dokuwiki:`Noise Test Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#noise_test_demo>`
#. :dokuwiki:`2 Wire RTD Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#wire_rtd_demo>`
#. :dokuwiki:`3 Wire RTD Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#wire_rtd_demo1>`
#. :dokuwiki:`4 Wire RTD Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#wire_rtd_demo2>`
#. :dokuwiki:`Thermocouple Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#thermocouple_demo>`
#. :dokuwiki:`Thermistor Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#thermistor_demo>`
#. :dokuwiki:`4 Wire Bridge Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#wire_bridge_demo>`
#. :dokuwiki:`6 Wire Bridge Demo </resources/eval/user-guides/ad4170/softwareprocedures/demo_modes#wire_bridge_demo1>`
...
#. Navigate to the Virtual Eval tool by clicking this link:
   `Virtual Eval <http://beta-tools.analog.com/virtualeval/>`__ or
   alternatively, by going to the AD4170 homepage on analog.com and finding the
   link there.
...
:dokuwiki:`Previous Page: Hardware Guide </resources/eval/user-guides/ad4170/hardwareguide>`

:dokuwiki:`Return to Homepage </resources/eval/user-guides/ad4170>`
